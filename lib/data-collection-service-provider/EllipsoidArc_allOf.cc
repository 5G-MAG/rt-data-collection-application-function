...
{
    return reinterpret_cast<data_collection_model_ellipsoid_arc_all_of_t*>(new std::shared_ptr<EllipsoidArc_allOf >(new EllipsoidArc_allOf(**reinterpret_cast<const std::shared_ptr<EllipsoidArc_allOf >*>(other))));
}
...
{
    return reinterpret_cast<data_collection_model_ellipsoid_arc_all_of_t*>(new std::shared_ptr<EllipsoidArc_allOf >(std::move(*reinterpret_cast<std::shared_ptr<EllipsoidArc_allOf >*>(other))));
}
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_ellipsoid_arc_all_of_t *data_collection_model_ellipsoid_arc_all_of_copy(data_collection_model_ellipsoid_arc_all_of_t *ellipsoid_arc_all_of, const data_collection_model_ellipsoid_arc_all_of_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<EllipsoidArc_allOf >*>(other);
...
{
    std::shared_ptr<EllipsoidArc_allOf > &obj = *reinterpret_cast<std::shared_ptr<EllipsoidArc_allOf >*>(ellipsoid_arc_all_of);
    obj = std::move(*reinterpret_cast<std::shared_ptr<EllipsoidArc_allOf >*>(other));
    return ellipsoid_arc_all_of;
}
...
{
    if (obj_ellipsoid_arc_all_of == NULL) return NULL;
