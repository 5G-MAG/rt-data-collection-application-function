...
{
    return reinterpret_cast<data_collection_model_qo_e_metrics_collection_t*>(new std::shared_ptr<QoEMetricsCollection >(new QoEMetricsCollection(**reinterpret_cast<const std::shared_ptr<QoEMetricsCollection >*>(other))));
}
...
{
    return reinterpret_cast<data_collection_model_qo_e_metrics_collection_t*>(new std::shared_ptr<QoEMetricsCollection >(std::move(*reinterpret_cast<std::shared_ptr<QoEMetricsCollection >*>(other))));
}
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_qo_e_metrics_collection_t *data_collection_model_qo_e_metrics_collection_copy(data_collection_model_qo_e_metrics_collection_t *qo_e_metrics_collection, const data_collection_model_qo_e_metrics_collection_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<QoEMetricsCollection >*>(other);
...
{
    std::shared_ptr<QoEMetricsCollection > &obj = *reinterpret_cast<std::shared_ptr<QoEMetricsCollection >*>(qo_e_metrics_collection);
    obj = std::move(*reinterpret_cast<std::shared_ptr<QoEMetricsCollection >*>(other));
    return qo_e_metrics_collection;
}
...
{
    if (obj_qo_e_metrics_collection == NULL) return NULL;
