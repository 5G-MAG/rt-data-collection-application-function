...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_tai_t *data_collection_model_tai_create_ref(const data_collection_model_tai_t *other)
{
    return reinterpret_cast<data_collection_model_tai_t*>(new std::shared_ptr<Tai>(*reinterpret_cast<const std::shared_ptr<Tai >*>(other)));
}
