...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_ncgi_t *data_collection_model_ncgi_create_ref(const data_collection_model_ncgi_t *other)
{
    return reinterpret_cast<data_collection_model_ncgi_t*>(new std::shared_ptr<Ncgi>(*reinterpret_cast<const std::shared_ptr<Ncgi >*>(other)));
}
