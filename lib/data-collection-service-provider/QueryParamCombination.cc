...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_query_param_combination_t *data_collection_model_query_param_combination_create_ref(const data_collection_model_query_param_combination_t *other)
{
    return reinterpret_cast<data_collection_model_query_param_combination_t*>(new std::shared_ptr<QueryParamCombination>(*reinterpret_cast<const std::shared_ptr<QueryParamCombination >*>(other)));
}
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_query_param_combination_t *data_collection_model_query_param_combination_add_query_params(data_collection_model_query_param_combination_t *obj_query_param_combination, data_collection_model_query_parameter_t* p_query_params)
{
    ...
    data_collection_model_query_parameter_free
(p_query_params);
