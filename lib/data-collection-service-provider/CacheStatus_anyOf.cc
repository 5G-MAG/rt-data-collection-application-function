...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_cache_status_any_of_t *data_collection_model_cache_status_any_of_create_ref(const data_collection_model_cache_status_any_of_t *other)
{
    return reinterpret_cast<data_collection_model_cache_status_any_of_t*>(new std::shared_ptr<CacheStatus_anyOf>(*reinterpret_cast<const std::shared_ptr<CacheStatus_anyOf >*>(other)));
}
