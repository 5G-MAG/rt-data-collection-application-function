...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_network_assistance_invocations_collection_all_of_t *data_collection_model_network_assistance_invocations_collection_all_of_create_ref(const data_collection_model_network_assistance_invocations_collection_all_of_t *other)
{
    return reinterpret_cast<data_collection_model_network_assistance_invocations_collection_all_of_t*>(new std::shared_ptr<NetworkAssistanceInvocationsCollection_allOf>(*reinterpret_cast<const std::shared_ptr<NetworkAssistanceInvocationsCollection_allOf >*>(other)));
}
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const data_collection_model_network_assistance_invocation_event_t* data_collection_model_network_assistance_invocations_collection_all_of_get_entry_records(const data_collection_model_network_assistance_invocations_collection_all_of_t *obj_network_assistance_invocations_collection_all_of, size_t idx)
{
    ...
    const NetworkAssistanceInvocationsCollection_allOf::RecordsType &container = obj->getRecords();
    ...
    typedef typename NetworkAssistanceInvocationsCollection_allOf::RecordsItemType ResultFromType;
