...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_network_assistance_invocations_collection_all_of_t *data_collection_model_network_assistance_invocations_collection_all_of_create(
)
{
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_network_assistance_invocations_collection_all_of_t *data_collection_model_network_assistance_invocations_collection_all_of_create_copy(const data_collection_model_network_assistance_invocations_collection_all_of_t *other)
{
    return reinterpret_cast<data_collection_model_network_assistance_invocations_collection_all_of_t*>(new std::shared_ptr<NetworkAssistanceInvocationsCollection_allOf >(new NetworkAssistanceInvocationsCollection_allOf(**reinterpret_cast<const std::shared_ptr<NetworkAssistanceInvocationsCollection_allOf >*>(other))));
}

DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_network_assistance_invocations_collection_all_of_t *data_collection_model_network_assistance_invocations_collection_all_of_create_move(data_collection_model_network_assistance_invocations_collection_all_of_t *other)
{
    return reinterpret_cast<data_collection_model_network_assistance_invocations_collection_all_of_t*>(new std::shared_ptr<NetworkAssistanceInvocationsCollection_allOf >(std::move(*reinterpret_cast<std::shared_ptr<NetworkAssistanceInvocationsCollection_allOf >*>(other))));
}

DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_network_assistance_invocations_collection_all_of_t *data_collection_model_network_assistance_invocations_collection_all_of_copy(data_collection_model_network_assistance_invocations_collection_all_of_t *network_assistance_invocations_collection_all_of, const data_collection_model_network_assistance_invocations_collection_all_of_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<NetworkAssistanceInvocationsCollection_allOf >*>(other);
...
{
    std::shared_ptr<NetworkAssistanceInvocationsCollection_allOf > &obj = *reinterpret_cast<std::shared_ptr<NetworkAssistanceInvocationsCollection_allOf >*>(network_assistance_invocations_collection_all_of);
    obj = std::move(*reinterpret_cast<std::shared_ptr<NetworkAssistanceInvocationsCollection_allOf >*>(other));
    return network_assistance_invocations_collection_all_of;
}

DATA_COLLECTION_SVC_PRODUCER_API extern "C" void data_collection_model_network_assistance_invocations_collection_all_of_free(data_collection_model_network_assistance_invocations_collection_all_of_t *network_assistance_invocations_collection_all_of)
{
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" cJSON *data_collection_model_network_assistance_invocations_collection_all_of_toJSON(const data_collection_model_network_assistance_invocations_collection_all_of_t *network_assistance_invocations_collection_all_of, bool as_request)
{
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_network_assistance_invocations_collection_all_of_t *data_collection_model_network_assistance_invocations_collection_all_of_fromJSON(cJSON *json, bool as_request, char **error_reason, char **error_class, char **error_parameter)
{
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" bool data_collection_model_network_assistance_invocations_collection_all_of_is_equal_to(const data_collection_model_network_assistance_invocations_collection_all_of_t *first, const data_collection_model_network_assistance_invocations_collection_all_of_t *second)
{
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" ogs_list_t* data_collection_model_network_assistance_invocations_collection_all_of_get_records(const data_collection_model_network_assistance_invocations_collection_all_of_t *obj_network_assistance_invocations_collection_all_of)
{
...
{
    if (obj_network_assistance_invocations_collection_all_of == NULL) return NULL;
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_lnode_t *data_collection_model_network_assistance_invocations_collection_all_of_make_lnode(data_collection_model_network_assistance_invocations_collection_all_of_t *p_network_assistance_invocations_collection_all_of)
{
