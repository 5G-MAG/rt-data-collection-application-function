...
typedef struct data_collection_model_exception_trend_s data_collection_model_exception_trend_t;

typedef enum {
    DCM_EXCEPTION_TREND_NO_VAL,
    DCM_EXCEPTION_TREND_VAL_UP,
    DCM_EXCEPTION_TREND_VAL_DOWN,
    DCM_EXCEPTION_TREND_VAL_UNKNOW,
    DCM_EXCEPTION_TREND_VAL_STABLE,
    DCM_EXCEPTION_TREND_OTHER
