...
/** A 3GPP NoProfileMatchReason object reference
 */
typedef struct data_collection_model_no_profile_match_reason_s
#ifdef DOXYGEN_ONLY
{
    int dummy; /**< \private placeholder */
}
#endif
data_collection_model_no_profile_match_reason_t;


/** NoProfileMatchReason enumerated values */
typedef enum {
    DCM_NO_PROFILE_MATCH_REASON_NO_VAL, /**< No value */
    DCM_NO_PROFILE_MATCH_REASON_VAL_REQUESTER_PLMN_NOT_ALLOWED, /**< REQUESTER_PLMN_NOT_ALLOWED */
    DCM_NO_PROFILE_MATCH_REASON_VAL_TARGET_NF_SUSPENDED, /**< TARGET_NF_SUSPENDED */
    DCM_NO_PROFILE_MATCH_REASON_VAL_TARGET_NF_UNDISCOVERABLE, /**< TARGET_NF_UNDISCOVERABLE */
    DCM_NO_PROFILE_MATCH_REASON_VAL_QUERY_PARAMS_COMBINATION_NO_MATCH, /**< QUERY_PARAMS_COMBINATION_NO_MATCH */
    DCM_NO_PROFILE_MATCH_REASON_VAL_TARGET_NF_TYPE_NOT_SUPPORTED, /**< TARGET_NF_TYPE_NOT_SUPPORTED */
    DCM_NO_PROFILE_MATCH_REASON_VAL_UNSPECIFIED, /**< UNSPECIFIED */
    DCM_NO_PROFILE_MATCH_REASON_OTHER  /**< Custom value (future expansion) */
...
/** Create a new reference of a NoProfileMatchReason object
 * \public \memberof data_collection_model_no_profile_match_reason_t
 * Creates a reference to the same underlying @a other object.
 * @param other The NoProfileMatchReason to create a new reference to.
 * @return a new NoProfileMatchReason object pointer reference.
 */
...
/** Copy the value of another NoProfileMatchReason into this object
 * \public \memberof data_collection_model_no_profile_match_reason_t
 * Copies the value of @a other {{classname} object into @a no_profile_match_reason.
 * @param no_profile_match_reason The NoProfileMatchReason object to copy @a other into.
 * @param other The NoProfileMatchReason to copy the value from.
 * @return @a no_profile_match_reason.
 */
...
/** Move the value of another NoProfileMatchReason into this object
 * \public \memberof data_collection_model_no_profile_match_reason_t
 * Discards the current value of @a no_profile_match_reason and moves the value of @a other
 * into @a no_profile_match_reason. This will leave @a other as an empty reference.
 *
 * @param no_profile_match_reason The NoProfileMatchReason object to move @a other into.
 * @param other The NoProfileMatchReason to move the value from.
 *
 * @return @a no_profile_match_reason.
 */
...
/** Delete a NoProfileMatchReason object
 * \public \memberof data_collection_model_no_profile_match_reason_t
 * Destroys the reference to the NoProfileMatchReason object and frees the value of NoProfileMatchReason if this is the last reference.
 *
 * @param no_profile_match_reason The NoProfileMatchReason to free.
 */
...
/** Get a cJSON tree representation of a NoProfileMatchReason
 * \public \memberof data_collection_model_no_profile_match_reason_t
 *
 * Create a cJSON tree representation of the NoProfileMatchReason object as either an API request or response. This respects fields marked
 * as Read-only (only in responses) or Write-only (only in requests) in the OpenAPI model description. The resulting cJSON tree
 * must be freed by the caller using the cJSON_Delete() function.
 *
 * @param no_profile_match_reason The NoProfileMatchReason to represent as a cJSON tree.
...
/** Parse a cJSON tree into a NoProfileMatchReason object
 * \public \memberof data_collection_model_no_profile_match_reason_t
 *
 * Attempts to interpret a cJSON tree as a NoProfileMatchReason API request or response (dependent on @a as_request value). If successful
 * will return a new referenced NoProfileMatchReason object containing the value represented by the cJSON tree. On failure will return
 ...
 * @param[out] error_parameter On failure will be set to the JSON path of the field where the failure happened if available or
                               `NULL`.
 *
 * @return a new NoProfileMatchReason object or `NULL` if the parsing failed.
 */
...
/** Compare two NoProfileMatchReason objects to see if they are equivalent
 * \public \memberof data_collection_model_no_profile_match_reason_t
 *
 * This will return `true` if the two objects are referencing the same object or the two objects have the same value.
 *
 * @param no_profile_match_reason The first NoProfileMatchReason object to compare.
 * @param other_no_profile_match_reason The second NoProfileMatchReason object to compare.
 *
...
/** Check if the NoProfileMatchReason enumeration object has a value set
 * \public \memberof data_collection_model_no_profile_match_reason_t
 *
 * @param no_profile_match_reason The NoProfileMatchReason enumeration object to check.
...
/** Check if the NoProfileMatchReason enumeration object has a custom value set
 * \public \memberof data_collection_model_no_profile_match_reason_t
 *
 * @param no_profile_match_reason The NoProfileMatchReason enumeration object to check.
...
/** Get the enumeration value for a NoProfileMatchReason object
 * \public \memberof data_collection_model_no_profile_match_reason_t
 *
 * @param no_profile_match_reason The NoProfileMatchReason object to extract the enumeration value from.
 *
 * @return the data_collection_model_no_profile_match_reason_e value represented by the NoProfileMatchReason object.
 */
...
/** Get the string representation of the enumeration value for a NoProfileMatchReason object
 * \public \memberof data_collection_model_no_profile_match_reason_t
 *
 * @param no_profile_match_reason The NoProfileMatchReason object to extract the enumeration value from.
 *
...
/** Set the enumeration value for a NoProfileMatchReason object
 * \public \memberof data_collection_model_no_profile_match_reason_t
 *
 * @param no_profile_match_reason The NoProfileMatchReason object to set the enumeration value for.
...
/** Set the enumeration value as a string for a NoProfileMatchReason object
 * \public \memberof data_collection_model_no_profile_match_reason_t
 *
 * Sets the enumeration value from the string given. If the string is a non-standard, custom value then the
 * data_collection_model_no_profile_match_reason_get_enum
 * function will return DCM_NO_PROFILE_MATCH_REASON_OTHER
 ...
 * \public \memberof data_collection_model_no_profile_match_reason_t
 *
 * Creates a new data_collection_lnode_t object containing the @a no_profile_match_reason object.
 * The @a no_profile_match_reason will be deleted when the data_collection_lnode_t is freed. Use
 * data_collection_lnode_create_ref() if you want an list node that will not delete the object when it is freed.
 *
 * @param no_profile_match_reason The NoProfileMatchReason object to create an data_collection_lnode_t object for.
 *
 * @return a new data_collection_lnode_t object containing the @a no_profile_match_reason
 */
