...
/** A 3GPP MediaType_anyOf object reference
 */
typedef struct data_collection_model_media_type_any_of_s
#ifdef DOXYGEN_ONLY
{
    int dummy; /**< \private placeholder */
}
#endif
data_collection_model_media_type_any_of_t;


/** MediaType_anyOf enumerated values */
typedef enum {
    DCM_MEDIA_TYPE_ANY_OF_NO_VAL, /**< No value */
    DCM_MEDIA_TYPE_ANY_OF_VAL_AUDIO, /**< AUDIO */
    DCM_MEDIA_TYPE_ANY_OF_VAL_VIDEO, /**< VIDEO */
    DCM_MEDIA_TYPE_ANY_OF_VAL_DATA, /**< DATA */
    DCM_MEDIA_TYPE_ANY_OF_VAL_APPLICATION, /**< APPLICATION */
    DCM_MEDIA_TYPE_ANY_OF_VAL_CONTROL, /**< CONTROL */
    DCM_MEDIA_TYPE_ANY_OF_VAL_TEXT, /**< TEXT */
    DCM_MEDIA_TYPE_ANY_OF_VAL_MESSAGE, /**< MESSAGE */
    DCM_MEDIA_TYPE_ANY_OF_VAL_OTHER /**< OTHER */
...
/** Create a new reference of a MediaType_anyOf object
 * \public \memberof data_collection_model_media_type_any_of_t
 * Creates a reference to the same underlying @a other object.
 * @param other The MediaType_anyOf to create a new reference to.
 * @return a new MediaType_anyOf object pointer reference.
 */
...
/** Copy the value of another MediaType_anyOf into this object
 * \public \memberof data_collection_model_media_type_any_of_t
 * Copies the value of @a other {{classname} object into @a media_type_any_of.
 * @param media_type_any_of The MediaType_anyOf object to copy @a other into.
 * @param other The MediaType_anyOf to copy the value from.
 * @return @a media_type_any_of.
 */
...
/** Move the value of another MediaType_anyOf into this object
 * \public \memberof data_collection_model_media_type_any_of_t
 * Discards the current value of @a media_type_any_of and moves the value of @a other
 * into @a media_type_any_of. This will leave @a other as an empty reference.
 *
 * @param media_type_any_of The MediaType_anyOf object to move @a other into.
 * @param other The MediaType_anyOf to move the value from.
 *
 * @return @a media_type_any_of.
 */
...
/** Delete a MediaType_anyOf object
 * \public \memberof data_collection_model_media_type_any_of_t
 * Destroys the reference to the MediaType_anyOf object and frees the value of MediaType_anyOf if this is the last reference.
 *
 * @param media_type_any_of The MediaType_anyOf to free.
 */
...
/** Get a cJSON tree representation of a MediaType_anyOf
 * \public \memberof data_collection_model_media_type_any_of_t
 *
 * Create a cJSON tree representation of the MediaType_anyOf object as either an API request or response. This respects fields marked
 * as Read-only (only in responses) or Write-only (only in requests) in the OpenAPI model description. The resulting cJSON tree
 * must be freed by the caller using the cJSON_Delete() function.
 *
 * @param media_type_any_of The MediaType_anyOf to represent as a cJSON tree.
...
/** Parse a cJSON tree into a MediaType_anyOf object
 * \public \memberof data_collection_model_media_type_any_of_t
 *
 * Attempts to interpret a cJSON tree as a MediaType_anyOf API request or response (dependent on @a as_request value). If successful
 * will return a new referenced MediaType_anyOf object containing the value represented by the cJSON tree. On failure will return
 ...
 * @param[out] error_parameter On failure will be set to the JSON path of the field where the failure happened if available or
                               `NULL`.
 *
 * @return a new MediaType_anyOf object or `NULL` if the parsing failed.
 */
...
/** Compare two MediaType_anyOf objects to see if they are equivalent
 * \public \memberof data_collection_model_media_type_any_of_t
 *
 * This will return `true` if the two objects are referencing the same object or the two objects have the same value.
 *
 * @param media_type_any_of The first MediaType_anyOf object to compare.
 * @param other_media_type_any_of The second MediaType_anyOf object to compare.
 *
 * @return `true` if the two objects are the same or have equal values, `false` otherwise.
 */
DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_media_type_any_of_is_equal_to(const data_collection_model_media_type_any_of_t *media_type_any_of, const data_collection_model_media_type_any_of_t *other_media_type_any_of);


/** Check if the MediaType_anyOf enumeration object has a value set
 * \public \memberof data_collection_model_media_type_any_of_t
 *
 * @param media_type_any_of The MediaType_anyOf enumeration object to check.
...
/** Get the enumeration value for a MediaType_anyOf object
 * \public \memberof data_collection_model_media_type_any_of_t
 *
 * @param media_type_any_of The MediaType_anyOf object to extract the enumeration value from.
 *
 * @return the data_collection_model_media_type_any_of_e value represented by the MediaType_anyOf object.
 */ 
...
/** Get the string representation of the enumeration value for a MediaType_anyOf object
 * \public \memberof data_collection_model_media_type_any_of_t 
 *
 * @param media_type_any_of The MediaType_anyOf object to extract the enumeration value from.
 *
...
/** Set the enumeration value for a MediaType_anyOf object
 * \public \memberof data_collection_model_media_type_any_of_t
 *
 * @param media_type_any_of The MediaType_anyOf object to set the enumeration value for.
...
/** Set the enumeration value as a string for a MediaType_anyOf object
 * \public \memberof data_collection_model_media_type_any_of_t
 *
 * @param media_type_any_of The MediaType_anyOf object to set the enumeration value for.
 * @param value The value to set.
 ...
 * \public \memberof data_collection_model_media_type_any_of_t
 *
 * Creates a new data_collection_lnode_t object containing the @a media_type_any_of object.
 * The @a media_type_any_of will be deleted when the data_collection_lnode_t is freed. Use
 * data_collection_lnode_create_ref() if you want an list node that will not delete the object when it is freed.
 *
 * @param media_type_any_of The MediaType_anyOf object to create an data_collection_lnode_t object for.
 *
 * @return a new data_collection_lnode_t object containing the @a media_type_any_of
 */
