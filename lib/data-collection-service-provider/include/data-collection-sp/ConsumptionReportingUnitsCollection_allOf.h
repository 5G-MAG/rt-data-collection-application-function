...
typedef struct data_collection_model_consumption_reporting_units_collection_all_of_s data_collection_model_consumption_reporting_units_collection_all_of_t;
