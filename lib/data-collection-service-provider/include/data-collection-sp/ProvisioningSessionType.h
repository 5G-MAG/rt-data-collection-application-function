...
typedef struct data_collection_model_provisioning_session_type_s data_collection_model_provisioning_session_type_t;

typedef enum {
    DCM_PROVISIONING_SESSION_TYPE_NO_VAL,
    DCM_PROVISIONING_SESSION_TYPE_VAL_MS_DOWNLINK,
    DCM_PROVISIONING_SESSION_TYPE_VAL_MS_UPLINK,
    DCM_PROVISIONING_SESSION_TYPE_VAL_RTC,
    DCM_PROVISIONING_SESSION_TYPE_OTHER
