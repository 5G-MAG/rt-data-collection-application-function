...
typedef struct data_collection_model_buffered_notifications_action_any_of_s data_collection_model_buffered_notifications_action_any_of_t;

typedef enum {
    DCM_BUFFERED_NOTIFICATIONS_ACTION_ANY_OF_NO_VAL,
    DCM_BUFFERED_NOTIFICATIONS_ACTION_ANY_OF_VAL_SEND_ALL,
    DCM_BUFFERED_NOTIFICATIONS_ACTION_ANY_OF_VAL_DISCARD_ALL,
    DCM_BUFFERED_NOTIFICATIONS_ACTION_ANY_OF_VAL_DROP_OLD
