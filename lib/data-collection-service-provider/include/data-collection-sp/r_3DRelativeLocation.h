...
/** Create a new r_3DRelativeLocation reference.
 * \public \memberof data_collection_model_r_3_d_relative_location_t
 * Creates a new reference to the same underlying object as \a other.
 * @param other The r_3DRelativeLocation to create a new reference to.
 * @return a new reference to the underlying object of \a other.
 */
DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_r_3_d_relative_location_t *data_collection_model_r_3_d_relative_location_create_ref(const data_collection_model_r_3_d_relative_location_t *other);
