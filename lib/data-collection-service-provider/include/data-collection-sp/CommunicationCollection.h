...
/** Create a new CommunicationCollection reference.
 * \public \memberof data_collection_model_communication_collection_t
 * Creates a new reference to the same underlying object as \a other.
 * @param other The CommunicationCollection to create a new reference to.
 * @return a new reference to the underlying object of \a other.
 */
DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_communication_collection_t *data_collection_model_communication_collection_create_ref(const data_collection_model_communication_collection_t *other);
