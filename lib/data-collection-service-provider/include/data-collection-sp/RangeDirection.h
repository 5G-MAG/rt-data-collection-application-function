...
DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_range_direction_t *data_collection_model_range_direction_set_range(data_collection_model_range_direction_t *range_direction, const double p_range);

DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_range_direction_t *data_collection_model_range_direction_set_range_move(data_collection_model_range_direction_t *range_direction, double p_range);
