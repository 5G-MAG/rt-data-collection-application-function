...
typedef struct data_collection_model_traffic_profile_any_of_s data_collection_model_traffic_profile_any_of_t;

typedef enum {
    DCM_TRAFFIC_PROFILE_ANY_OF_NO_VAL,
    DCM_TRAFFIC_PROFILE_ANY_OF_VAL_SINGLE_TRANS_UL,
    DCM_TRAFFIC_PROFILE_ANY_OF_VAL_SINGLE_TRANS_DL,
    DCM_TRAFFIC_PROFILE_ANY_OF_VAL_DUAL_TRANS_UL_FIRST,
    DCM_TRAFFIC_PROFILE_ANY_OF_VAL_DUAL_TRANS_DL_FIRST,
    DCM_TRAFFIC_PROFILE_ANY_OF_VAL_MULTI_TRANS
