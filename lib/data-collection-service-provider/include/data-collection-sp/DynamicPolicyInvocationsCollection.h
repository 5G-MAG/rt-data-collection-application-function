...
/** A 3GPP DynamicPolicyInvocationsCollection object reference
 */
typedef struct data_collection_model_dynamic_policy_invocations_collection_s
#ifdef DOXYGEN_ONLY
{
...
/** Create a new DynamicPolicyInvocationsCollection.
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 * @return a new DynamicPolicyInvocationsCollection object pointer.
 */
...
/** Create a new DynamicPolicyInvocationsCollection reference.
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 * Creates a new reference to the same underlying object as \a other.
 * @param other The DynamicPolicyInvocationsCollection to create a new reference to.
 * @return a new reference to the underlying object of \a other.
 */
DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_dynamic_policy_invocations_collection_t *data_collection_model_dynamic_policy_invocations_collection_create_ref(const data_collection_model_dynamic_policy_invocations_collection_t *other);

/** Create a new copy of a DynamicPolicyInvocationsCollection object.
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 * Creates a new copy of the given @a other object
 * @param other The DynamicPolicyInvocationsCollection to copy.
 * @return a new DynamicPolicyInvocationsCollection object pointer.
 */
...
/** Create a new reference of a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 * Creates a reference to the same underlying @a other object.
 * @param other The DynamicPolicyInvocationsCollection to create a new reference to.
 * @return a new DynamicPolicyInvocationsCollection object pointer reference.
 */
...
/** Copy the value of another DynamicPolicyInvocationsCollection into this object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 * Copies the value of @a other {{classname} object into @a dynamic_policy_invocations_collection.
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to copy @a other into.
 * @param other The DynamicPolicyInvocationsCollection to copy the value from.
 * @return @a dynamic_policy_invocations_collection.
 */
...
/** Move the value of another DynamicPolicyInvocationsCollection into this object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 * Discards the current value of @a dynamic_policy_invocations_collection and moves the value of @a other
 * into @a dynamic_policy_invocations_collection. This will leave @a other as an empty reference.
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to move @a other into.
 * @param other The DynamicPolicyInvocationsCollection to move the value from.
 *
 * @return @a dynamic_policy_invocations_collection.
 */
...
/** Delete a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 * Destroys the reference to the DynamicPolicyInvocationsCollection object and frees the value of DynamicPolicyInvocationsCollection if this is the last reference.
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection to free.
 */
...
/** Get a cJSON tree representation of a DynamicPolicyInvocationsCollection
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * Create a cJSON tree representation of the DynamicPolicyInvocationsCollection object as either an API request or response. This respects fields marked
 * as Read-only (only in responses) or Write-only (only in requests) in the OpenAPI model description. The resulting cJSON tree
 * must be freed by the caller using the cJSON_Delete() function.
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection to represent as a cJSON tree.
...
/** Parse a cJSON tree into a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * Attempts to interpret a cJSON tree as a DynamicPolicyInvocationsCollection API request or response (dependent on @a as_request value). If successful
 * will return a new referenced DynamicPolicyInvocationsCollection object containing the value represented by the cJSON tree. On failure will return
 ...
 * @param[out] error_parameter On failure will be set to the JSON path of the field where the failure happened if available or
                               `NULL`.
 *
 * @return a new DynamicPolicyInvocationsCollection object or `NULL` if the parsing failed.
 */
...
/** Compare two DynamicPolicyInvocationsCollection objects to see if they are equivalent
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * This will return `true` if the two objects are referencing the same object or the two objects have the same value.
 *
 * @param dynamic_policy_invocations_collection The first DynamicPolicyInvocationsCollection object to compare.
 * @param other_dynamic_policy_invocations_collection The second DynamicPolicyInvocationsCollection object to compare.
 *
...
/** Get the value of the collectionTimestamp field of a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to examine.
 *
...
/** Set the value of the collectionTimestamp field in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to set the field in.
 * @param p_collection_timestamp The value to copy into the DynamicPolicyInvocationsCollection object.
 *
 * @return @a dynamic_policy_invocations_collection.
 */
DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_dynamic_policy_invocations_collection_t *data_collection_model_dynamic_policy_invocations_collection_set_collection_timestamp(data_collection_model_dynamic_policy_invocations_collection_t *dynamic_policy_invocations_collection, const char* p_collection_timestamp);

/** Move a value to the collectionTimestamp field in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to set the field in.
 * @param p_collection_timestamp The value to move into the DynamicPolicyInvocationsCollection object.
 *
 * @return @a dynamic_policy_invocations_collection.
 */
...
/** Get the value of the startTimestamp field of a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to examine.
 *
...
/** Set the value of the startTimestamp field in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to set the field in.
 * @param p_start_timestamp The value to copy into the DynamicPolicyInvocationsCollection object.
 *
 * @return @a dynamic_policy_invocations_collection.
 */
DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_dynamic_policy_invocations_collection_t *data_collection_model_dynamic_policy_invocations_collection_set_start_timestamp(data_collection_model_dynamic_policy_invocations_collection_t *dynamic_policy_invocations_collection, const char* p_start_timestamp);

/** Move a value to the startTimestamp field in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to set the field in.
 * @param p_start_timestamp The value to move into the DynamicPolicyInvocationsCollection object.
 *
 * @return @a dynamic_policy_invocations_collection.
 */
...
/** Get the value of the endTimestamp field of a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to examine.
 *
...
/** Set the value of the endTimestamp field in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to set the field in.
 * @param p_end_timestamp The value to copy into the DynamicPolicyInvocationsCollection object.
 *
 * @return @a dynamic_policy_invocations_collection.
 */
...
/** Move a value to the endTimestamp field in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to set the field in.
 * @param p_end_timestamp The value to move into the DynamicPolicyInvocationsCollection object.
 *
 * @return @a dynamic_policy_invocations_collection.
 */
...
/** Get the value of the sampleCount field of a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to examine.
 *
...
/** Set the value of the sampleCount field in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to set the field in.
 * @param p_sample_count The value to copy into the DynamicPolicyInvocationsCollection object.
 *
 * @return @a dynamic_policy_invocations_collection.
 */
...
/** Move a value to the sampleCount field in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to set the field in.
 * @param p_sample_count The value to move into the DynamicPolicyInvocationsCollection object.
 *
 * @return @a dynamic_policy_invocations_collection.
 */
...
/** Get the value of the streamingDirection field of a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to examine.
 *
...
/** Set the value of the streamingDirection field in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to set the field in.
 * @param p_streaming_direction The value to copy into the DynamicPolicyInvocationsCollection object.
 *
 * @return @a dynamic_policy_invocations_collection.
 */
...
/** Move a value to the streamingDirection field in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to set the field in.
 * @param p_streaming_direction The value to move into the DynamicPolicyInvocationsCollection object.
 *
 * @return @a dynamic_policy_invocations_collection.
 */
...
/** Get the value of the summarisations field of a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to examine.
 *
...
/** Set the value of the summarisations field in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to set the field in.
 * @param p_summarisations The value to copy into the DynamicPolicyInvocationsCollection object.
 *
 * @return @a dynamic_policy_invocations_collection.
 */
DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_dynamic_policy_invocations_collection_t *data_collection_model_dynamic_policy_invocations_collection_set_summarisations(data_collection_model_dynamic_policy_invocations_collection_t *dynamic_policy_invocations_collection, const ogs_list_t* p_summarisations);

/** Move a value to the summarisations field in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to set the field in.
 * @param p_summarisations The value to move into the DynamicPolicyInvocationsCollection object.
 *
 * @return @a dynamic_policy_invocations_collection.
 */
DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_dynamic_policy_invocations_collection_t *data_collection_model_dynamic_policy_invocations_collection_set_summarisations_move(data_collection_model_dynamic_policy_invocations_collection_t *dynamic_policy_invocations_collection, ogs_list_t* p_summarisations);

/** Add a new item to the summarisations array in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to add the array item to.
...
/** Remove an item from the summarisations array in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to remove the array value from.
...
/** Get an item from the summarisations array in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to examine.
...
/** Remove all entries from the summarisations array in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to empty summarisations for.
 *
 * @return @a dynamic_policy_invocations_collection
 */ 
...
/** Get the value of the records field of a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to examine.
 *
...
/** Set the value of the records field in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to set the field in.
 * @param p_records The value to copy into the DynamicPolicyInvocationsCollection object.
 *
 * @return @a dynamic_policy_invocations_collection.
 */
...
/** Move a value to the records field in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to set the field in.
 * @param p_records The value to move into the DynamicPolicyInvocationsCollection object.
 *
 * @return @a dynamic_policy_invocations_collection.
 */
...
/** Add a new item to the records array in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to add the array item to.
...
/** Remove an item from the records array in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to remove the array value from.
...
/** Get an item from the records array in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to examine.
 * @param idx The index of the value to retrieve.
...
/** Remove all entries from the records array in a DynamicPolicyInvocationsCollection object
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to empty records for.
 *
 * @return @a dynamic_policy_invocations_collection
 */ 
 ...
 * \public \memberof data_collection_model_dynamic_policy_invocations_collection_t
 *
 * Creates a new data_collection_lnode_t object containing the @a dynamic_policy_invocations_collection object.
 * The @a dynamic_policy_invocations_collection will be deleted when the data_collection_lnode_t is freed. Use
 * data_collection_lnode_create_ref() if you want an list node that will not delete the object when it is freed.
 *
 * @param dynamic_policy_invocations_collection The DynamicPolicyInvocationsCollection object to create an data_collection_lnode_t object for.
 *
 * @return a new data_collection_lnode_t object containing the @a dynamic_policy_invocations_collection
 */
