...
/** Create a new PerFlowServiceExperienceInfo reference.
 * \public \memberof data_collection_model_per_flow_service_experience_info_t
 * Creates a new reference to the same underlying object as \a other.
 * @param other The PerFlowServiceExperienceInfo to create a new reference to.
 * @return a new reference to the underlying object of \a other.
 */
DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_per_flow_service_experience_info_t *data_collection_model_per_flow_service_experience_info_create_ref(const data_collection_model_per_flow_service_experience_info_t *other);
