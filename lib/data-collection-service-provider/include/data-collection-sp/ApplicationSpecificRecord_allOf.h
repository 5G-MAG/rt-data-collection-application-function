...
/** Create a new ApplicationSpecificRecord_allOf reference.
 * \public \memberof data_collection_model_application_specific_record_all_of_t
 * Creates a new reference to the same underlying object as \a other.
 * @param other The ApplicationSpecificRecord_allOf to create a new reference to.
 * @return a new reference to the underlying object of \a other.
 */
DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_application_specific_record_all_of_t *data_collection_model_application_specific_record_all_of_create_ref(const data_collection_model_application_specific_record_all_of_t *other);
