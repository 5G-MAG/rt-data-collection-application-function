...
typedef struct data_collection_model_event_consumer_type_s data_collection_model_event_consumer_type_t;

typedef enum {
    DCM_EVENT_CONSUMER_TYPE_NO_VAL,
    DCM_EVENT_CONSUMER_TYPE_VAL_NWDAF,
    DCM_EVENT_CONSUMER_TYPE_VAL_EVENT_CONSUMER_AF,
    DCM_EVENT_CONSUMER_TYPE_VAL_NEF,
    DCM_EVENT_CONSUMER_TYPE_OTHER
