...
/** A 3GPP DataAccessProfile_timeAccessRestrictions object reference
 */
typedef struct data_collection_model_data_access_profile_time_access_restrictions_s
#ifdef DOXYGEN_ONLY
{
...
/** Create a new DataAccessProfile_timeAccessRestrictions.
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 * @return a new DataAccessProfile_timeAccessRestrictions object pointer.
 */
...
/** Create a new DataAccessProfile_timeAccessRestrictions reference.
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 * Creates a new reference to the same underlying object as \a other.
 * @param other The DataAccessProfile_timeAccessRestrictions to create a new reference to.
 * @return a new reference to the underlying object of \a other.
 */
DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_data_access_profile_time_access_restrictions_t *data_collection_model_data_access_profile_time_access_restrictions_create_ref(const data_collection_model_data_access_profile_time_access_restrictions_t *other);

/** Create a new copy of a DataAccessProfile_timeAccessRestrictions object.
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 * Creates a new copy of the given @a other object
 * @param other The DataAccessProfile_timeAccessRestrictions to copy.
 * @return a new DataAccessProfile_timeAccessRestrictions object pointer.
 */
...
/** Create a new reference of a DataAccessProfile_timeAccessRestrictions object
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 * Creates a reference to the same underlying @a other object.
 * @param other The DataAccessProfile_timeAccessRestrictions to create a new reference to.
 * @return a new DataAccessProfile_timeAccessRestrictions object pointer reference.
 */
...
/** Copy the value of another DataAccessProfile_timeAccessRestrictions into this object
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 * Copies the value of @a other {{classname} object into @a data_access_profile_time_access_restrictions.
 * @param data_access_profile_time_access_restrictions The DataAccessProfile_timeAccessRestrictions object to copy @a other into.
 * @param other The DataAccessProfile_timeAccessRestrictions to copy the value from.
 * @return @a data_access_profile_time_access_restrictions.
 */
...
/** Move the value of another DataAccessProfile_timeAccessRestrictions into this object
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 * Discards the current value of @a data_access_profile_time_access_restrictions and moves the value of @a other
 * into @a data_access_profile_time_access_restrictions. This will leave @a other as an empty reference.
 *
 * @param data_access_profile_time_access_restrictions The DataAccessProfile_timeAccessRestrictions object to move @a other into.
 * @param other The DataAccessProfile_timeAccessRestrictions to move the value from.
 *
 * @return @a data_access_profile_time_access_restrictions.
 */
...
/** Delete a DataAccessProfile_timeAccessRestrictions object
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 * Destroys the reference to the DataAccessProfile_timeAccessRestrictions object and frees the value of DataAccessProfile_timeAccessRestrictions if this is the last reference.
 *
 * @param data_access_profile_time_access_restrictions The DataAccessProfile_timeAccessRestrictions to free.
 */
...
/** Get a cJSON tree representation of a DataAccessProfile_timeAccessRestrictions
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 *
 * Create a cJSON tree representation of the DataAccessProfile_timeAccessRestrictions object as either an API request or response. This respects fields marked
 * as Read-only (only in responses) or Write-only (only in requests) in the OpenAPI model description. The resulting cJSON tree
 * must be freed by the caller using the cJSON_Delete() function.
 *
 * @param data_access_profile_time_access_restrictions The DataAccessProfile_timeAccessRestrictions to represent as a cJSON tree.
...
/** Parse a cJSON tree into a DataAccessProfile_timeAccessRestrictions object
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 *
 * Attempts to interpret a cJSON tree as a DataAccessProfile_timeAccessRestrictions API request or response (dependent on @a as_request value). If successful
 * will return a new referenced DataAccessProfile_timeAccessRestrictions object containing the value represented by the cJSON tree. On failure will return
 ...
 * @param[out] error_parameter On failure will be set to the JSON path of the field where the failure happened if available or
                               `NULL`.
 *
 * @return a new DataAccessProfile_timeAccessRestrictions object or `NULL` if the parsing failed.
 */
...
/** Compare two DataAccessProfile_timeAccessRestrictions objects to see if they are equivalent
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 *
 * This will return `true` if the two objects are referencing the same object or the two objects have the same value.
 *
 * @param data_access_profile_time_access_restrictions The first DataAccessProfile_timeAccessRestrictions object to compare.
 * @param other_data_access_profile_time_access_restrictions The second DataAccessProfile_timeAccessRestrictions object to compare.
 *
...
/** Get the value of the duration field of a DataAccessProfile_timeAccessRestrictions object
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 *
 * @param data_access_profile_time_access_restrictions The DataAccessProfile_timeAccessRestrictions object to examine.
 *
...
/** Set the value of the duration field in a DataAccessProfile_timeAccessRestrictions object
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 *
 * @param data_access_profile_time_access_restrictions The DataAccessProfile_timeAccessRestrictions object to set the field in.
 * @param p_duration The value to copy into the DataAccessProfile_timeAccessRestrictions object.
 *
 * @return @a data_access_profile_time_access_restrictions.
 */
...
/** Move a value to the duration field in a DataAccessProfile_timeAccessRestrictions object
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 *
 * @param data_access_profile_time_access_restrictions The DataAccessProfile_timeAccessRestrictions object to set the field in.
 * @param p_duration The value to move into the DataAccessProfile_timeAccessRestrictions object.
 *
 * @return @a data_access_profile_time_access_restrictions.
 */
...
/** Get the value of the aggregationFunctions field of a DataAccessProfile_timeAccessRestrictions object
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 *
 * @param data_access_profile_time_access_restrictions The DataAccessProfile_timeAccessRestrictions object to examine.
 *
...
/** Set the value of the aggregationFunctions field in a DataAccessProfile_timeAccessRestrictions object
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 *
 * @param data_access_profile_time_access_restrictions The DataAccessProfile_timeAccessRestrictions object to set the field in.
 * @param p_aggregation_functions The value to copy into the DataAccessProfile_timeAccessRestrictions object.
 *
 * @return @a data_access_profile_time_access_restrictions.
 */
...
/** Move a value to the aggregationFunctions field in a DataAccessProfile_timeAccessRestrictions object
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 *
 * @param data_access_profile_time_access_restrictions The DataAccessProfile_timeAccessRestrictions object to set the field in.
 * @param p_aggregation_functions The value to move into the DataAccessProfile_timeAccessRestrictions object.
 *
 * @return @a data_access_profile_time_access_restrictions.
 */
...
/** Add a new item to the aggregationFunctions array in a DataAccessProfile_timeAccessRestrictions object
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 *
 * @param data_access_profile_time_access_restrictions The DataAccessProfile_timeAccessRestrictions object to add the array item to.
...
/** Remove an item from the aggregationFunctions array in a DataAccessProfile_timeAccessRestrictions object
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 *
 * @param data_access_profile_time_access_restrictions The DataAccessProfile_timeAccessRestrictions object to remove the array value from.
...
/** Get an item from the aggregationFunctions array in a DataAccessProfile_timeAccessRestrictions object
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 *
 * @param data_access_profile_time_access_restrictions The DataAccessProfile_timeAccessRestrictions object to examine.
 ...
 */
DATA_COLLECTION_SVC_PRODUCER_API const data_collection_model_data_aggregation_function_type_t* data_collection_model_data_access_profile_time_access_restrictions_get_entry_aggregation_functions(const data_collection_model_data_access_profile_time_access_restrictions_t *data_access_profile_time_access_restrictions, size_t idx);

/** Remove all entries from the aggregationFunctions array in a DataAccessProfile_timeAccessRestrictions object
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 *
 * @param data_access_profile_time_access_restrictions The DataAccessProfile_timeAccessRestrictions object to empty aggregationFunctions for.
 *
 * @return @a data_access_profile_time_access_restrictions
 */ 
 ...
 * \public \memberof data_collection_model_data_access_profile_time_access_restrictions_t
 *
 * Creates a new data_collection_lnode_t object containing the @a data_access_profile_time_access_restrictions object.
 * The @a data_access_profile_time_access_restrictions will be deleted when the data_collection_lnode_t is freed. Use
 * data_collection_lnode_create_ref() if you want an list node that will not delete the object when it is freed.
 *
 * @param data_access_profile_time_access_restrictions The DataAccessProfile_timeAccessRestrictions object to create an data_collection_lnode_t object for.
 *
 * @return a new data_collection_lnode_t object containing the @a data_access_profile_time_access_restrictions
 */
