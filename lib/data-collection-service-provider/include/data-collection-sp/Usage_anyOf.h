...
typedef struct data_collection_model_usage_any_of_s data_collection_model_usage_any_of_t;

typedef enum {
    DCM_USAGE_ANY_OF_NO_VAL,
    DCM_USAGE_ANY_OF_VAL_UNSUCCESS,
    DCM_USAGE_ANY_OF_VAL_SUCCESS_RESULTS_NOT_USED,
    DCM_USAGE_ANY_OF_VAL_SUCCESS_RESULTS_USED_TO_VERIFY_LOCATION,
    DCM_USAGE_ANY_OF_VAL_SUCCESS_RESULTS_USED_TO_GENERATE_LOCATION,
    DCM_USAGE_ANY_OF_VAL_SUCCESS_METHOD_NOT_DETERMINED
