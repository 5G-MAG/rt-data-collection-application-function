...
/** A 3GPP QoEMetricsEvent object reference
 */
typedef struct data_collection_model_qo_e_metrics_event_s
#ifdef DOXYGEN_ONLY
{
    int dummy; /**< \private placeholder */
}
#endif
data_collection_model_qo_e_metrics_event_t;



/** Create a new QoEMetricsEvent.
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 * @return a new QoEMetricsEvent object pointer.
 */
...
/** Create a new QoEMetricsEvent reference.
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 * Creates a new reference to the same underlying object as \a other.
 * @param other The QoEMetricsEvent to create a new reference to.
 * @return a new reference to the underlying object of \a other.
 */
DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_qo_e_metrics_event_t *data_collection_model_qo_e_metrics_event_create_ref(const data_collection_model_qo_e_metrics_event_t *other);

/** Create a new copy of a QoEMetricsEvent object.
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 * Creates a new copy of the given @a other object
 * @param other The QoEMetricsEvent to copy.
 * @return a new QoEMetricsEvent object pointer.
 */
...
/** Create a new reference of a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 * Creates a reference to the same underlying @a other object.
 * @param other The QoEMetricsEvent to create a new reference to.
 * @return a new QoEMetricsEvent object pointer reference.
 */
...
/** Copy the value of another QoEMetricsEvent into this object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 * Copies the value of @a other {{classname} object into @a qo_e_metrics_event.
 * @param qo_e_metrics_event The QoEMetricsEvent object to copy @a other into.
 * @param other The QoEMetricsEvent to copy the value from.
 * @return @a qo_e_metrics_event.
 */
...
/** Move the value of another QoEMetricsEvent into this object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 * Discards the current value of @a qo_e_metrics_event and moves the value of @a other
 * into @a qo_e_metrics_event. This will leave @a other as an empty reference.
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to move @a other into.
 * @param other The QoEMetricsEvent to move the value from.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Delete a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 * Destroys the reference to the QoEMetricsEvent object and frees the value of QoEMetricsEvent if this is the last reference.
 *
 * @param qo_e_metrics_event The QoEMetricsEvent to free.
 */
...
/** Get a cJSON tree representation of a QoEMetricsEvent
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * Create a cJSON tree representation of the QoEMetricsEvent object as either an API request or response. This respects fields marked
 * as Read-only (only in responses) or Write-only (only in requests) in the OpenAPI model description. The resulting cJSON tree
 * must be freed by the caller using the cJSON_Delete() function.
 *
 * @param qo_e_metrics_event The QoEMetricsEvent to represent as a cJSON tree.
...
/** Parse a cJSON tree into a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * Attempts to interpret a cJSON tree as a QoEMetricsEvent API request or response (dependent on @a as_request value). If successful
 * will return a new referenced QoEMetricsEvent object containing the value represented by the cJSON tree. On failure will return
 ...
 * @param[out] error_parameter On failure will be set to the JSON path of the field where the failure happened if available or
                               `NULL`.
 *
 * @return a new QoEMetricsEvent object or `NULL` if the parsing failed.
 */
...
/** Compare two QoEMetricsEvent objects to see if they are equivalent
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * This will return `true` if the two objects are referencing the same object or the two objects have the same value.
 *
 * @param qo_e_metrics_event The first QoEMetricsEvent object to compare.
 * @param other_qo_e_metrics_event The second QoEMetricsEvent object to compare.
 *
...
/** Get the value of the recordType field of a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Set the value of the recordType field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_record_type The value to copy into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Move a value to the recordType field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_record_type The value to move into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Get the value of the recordTimestamp field of a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Set the value of the recordTimestamp field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_record_timestamp The value to copy into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Move a value to the recordTimestamp field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_record_timestamp The value to move into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Get the value of the appId field of a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Set the value of the appId field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_app_id The value to copy into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Move a value to the appId field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_app_id The value to move into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Check if the provisioningSessionId field of a QoEMetricsEvent object is set
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Get the value of the provisioningSessionId field of a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Set the value of the provisioningSessionId field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_provisioning_session_id The value to copy into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Move a value to the provisioningSessionId field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_provisioning_session_id The value to move into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Check if the sessionId field of a QoEMetricsEvent object is set
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Get the value of the sessionId field of a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Set the value of the sessionId field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_session_id The value to copy into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Move a value to the sessionId field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_session_id The value to move into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Check if the ueIdentification field of a QoEMetricsEvent object is set
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Get the value of the ueIdentification field of a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Set the value of the ueIdentification field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_ue_identification The value to copy into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Move a value to the ueIdentification field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_ue_identification The value to move into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Check if the dataNetworkName field of a QoEMetricsEvent object is set
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Get the value of the dataNetworkName field of a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Set the value of the dataNetworkName field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_data_network_name The value to copy into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Move a value to the dataNetworkName field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_data_network_name The value to move into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Check if the sliceId field of a QoEMetricsEvent object is set
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Get the value of the sliceId field of a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Set the value of the sliceId field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_slice_id The value to copy into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Move a value to the sliceId field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_slice_id The value to move into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Check if the ueLocations field of a QoEMetricsEvent object is set
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Get the value of the ueLocations field of a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Set the value of the ueLocations field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_ue_locations The value to copy into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Move a value to the ueLocations field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_ue_locations The value to move into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Add a new item to the ueLocations array in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to add the array item to.
...
/** Remove an item from the ueLocations array in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to remove the array value from.
...
/** Get an item from the ueLocations array in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
...
/** Remove all entries from the ueLocations array in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to empty ueLocations for.
 *
 * @return @a qo_e_metrics_event
 */ 
...
/** Get the value of the metricType field of a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Set the value of the metricType field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_metric_type The value to copy into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Move a value to the metricType field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_metric_type The value to move into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Check if the samples field of a QoEMetricsEvent object is set
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Get the value of the samples field of a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 *
...
/** Set the value of the samples field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_samples The value to copy into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Move a value to the samples field in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to set the field in.
 * @param p_samples The value to move into the QoEMetricsEvent object.
 *
 * @return @a qo_e_metrics_event.
 */
...
/** Add a new item to the samples array in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to add the array item to.
...
/** Remove an item from the samples array in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to remove the array value from.
...
/** Get an item from the samples array in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to examine.
 * @param idx The index of the value to retrieve.
...
/** Remove all entries from the samples array in a QoEMetricsEvent object
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to empty samples for.
 *
 * @return @a qo_e_metrics_event
 */ 
 ...
 * \public \memberof data_collection_model_qo_e_metrics_event_t
 *
 * Creates a new data_collection_lnode_t object containing the @a qo_e_metrics_event object.
 * The @a qo_e_metrics_event will be deleted when the data_collection_lnode_t is freed. Use
 * data_collection_lnode_create_ref() if you want an list node that will not delete the object when it is freed.
 *
 * @param qo_e_metrics_event The QoEMetricsEvent object to create an data_collection_lnode_t object for.
 *
 * @return a new data_collection_lnode_t object containing the @a qo_e_metrics_event
 */
