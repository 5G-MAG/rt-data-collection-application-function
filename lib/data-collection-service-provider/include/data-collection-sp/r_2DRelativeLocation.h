...
/** A 3GPP r_2DRelativeLocation object reference
 */
typedef struct data_collection_model_r_2_d_relative_location_s
#ifdef DOXYGEN_ONLY
{
    int dummy; /**< \private placeholder */
}
#endif
data_collection_model_r_2_d_relative_location_t;
...
/** Create a new reference of a r_2DRelativeLocation object
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 * Creates a reference to the same underlying @a other object.
 * @param other The r_2DRelativeLocation to create a new reference to.
 * @return a new r_2DRelativeLocation object pointer reference.
 */
...
/** Copy the value of another r_2DRelativeLocation into this object
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 * Copies the value of @a other {{classname} object into @a r_2_d_relative_location.
 * @param r_2_d_relative_location The r_2DRelativeLocation object to copy @a other into.
 * @param other The r_2DRelativeLocation to copy the value from.
 * @return @a r_2_d_relative_location.
 */
...
/** Move the value of another r_2DRelativeLocation into this object
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 * Discards the current value of @a r_2_d_relative_location and moves the value of @a other
 * into @a r_2_d_relative_location. This will leave @a other as an empty reference.
 *
 * @param r_2_d_relative_location The r_2DRelativeLocation object to move @a other into.
 * @param other The r_2DRelativeLocation to move the value from.
 *
 * @return @a r_2_d_relative_location.
 */
...
/** Delete a r_2DRelativeLocation object
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 * Destroys the reference to the r_2DRelativeLocation object and frees the value of r_2DRelativeLocation if this is the last reference.
 *
 * @param r_2_d_relative_location The r_2DRelativeLocation to free.
 */
...
/** Get a cJSON tree representation of a r_2DRelativeLocation
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 *
 * Create a cJSON tree representation of the r_2DRelativeLocation object as either an API request or response. This respects fields marked
 * as Read-only (only in responses) or Write-only (only in requests) in the OpenAPI model description. The resulting cJSON tree
 * must be freed by the caller using the cJSON_Delete() function.
 *
 * @param r_2_d_relative_location The r_2DRelativeLocation to represent as a cJSON tree.
...
/** Parse a cJSON tree into a r_2DRelativeLocation object
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 *
 * Attempts to interpret a cJSON tree as a r_2DRelativeLocation API request or response (dependent on @a as_request value). If successful
 * will return a new referenced r_2DRelativeLocation object containing the value represented by the cJSON tree. On failure will return
 ...
 * @param[out] error_parameter On failure will be set to the JSON path of the field where the failure happened if available or
                               `NULL`.
 *
 * @return a new r_2DRelativeLocation object or `NULL` if the parsing failed.
 */
...
/** Compare two r_2DRelativeLocation objects to see if they are equivalent
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 *
 * This will return `true` if the two objects are referencing the same object or the two objects have the same value.
 *
 * @param r_2_d_relative_location The first r_2DRelativeLocation object to compare.
 * @param other_r_2_d_relative_location The second r_2DRelativeLocation object to compare.
 *
...
/** Check if the semiMinor field of a r_2DRelativeLocation object is set
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 *
 * @param r_2_d_relative_location The r_2DRelativeLocation object to examine.
 *
...
/** Get the value of the semiMinor field of a r_2DRelativeLocation object
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 *
 * @param r_2_d_relative_location The r_2DRelativeLocation object to examine.
 *
...
/** Set the value of the semiMinor field in a r_2DRelativeLocation object
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 *
 * @param r_2_d_relative_location The r_2DRelativeLocation object to set the field in.
 * @param p_semi_minor The value to copy into the r_2DRelativeLocation object.
 *
 * @return @a r_2_d_relative_location.
 */
...
/** Move a value to the semiMinor field in a r_2DRelativeLocation object
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 *
 * @param r_2_d_relative_location The r_2DRelativeLocation object to set the field in.
 * @param p_semi_minor The value to move into the r_2DRelativeLocation object.
 *
 * @return @a r_2_d_relative_location.
 */
...
/** Check if the semiMajor field of a r_2DRelativeLocation object is set
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 *
 * @param r_2_d_relative_location The r_2DRelativeLocation object to examine.
 *
...
/** Get the value of the semiMajor field of a r_2DRelativeLocation object
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 *
 * @param r_2_d_relative_location The r_2DRelativeLocation object to examine.
 *
...
/** Set the value of the semiMajor field in a r_2DRelativeLocation object
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 *
 * @param r_2_d_relative_location The r_2DRelativeLocation object to set the field in.
 * @param p_semi_major The value to copy into the r_2DRelativeLocation object.
 *
 * @return @a r_2_d_relative_location.
 */
...
/** Move a value to the semiMajor field in a r_2DRelativeLocation object
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 *
 * @param r_2_d_relative_location The r_2DRelativeLocation object to set the field in.
 * @param p_semi_major The value to move into the r_2DRelativeLocation object.
 *
 * @return @a r_2_d_relative_location.
 */
...
/** Check if the orientationAngle field of a r_2DRelativeLocation object is set
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 *
 * @param r_2_d_relative_location The r_2DRelativeLocation object to examine.
 *
...
/** Get the value of the orientationAngle field of a r_2DRelativeLocation object
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 *
 * @param r_2_d_relative_location The r_2DRelativeLocation object to examine.
 *
...
/** Set the value of the orientationAngle field in a r_2DRelativeLocation object
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 *
 * @param r_2_d_relative_location The r_2DRelativeLocation object to set the field in.
 * @param p_orientation_angle The value to copy into the r_2DRelativeLocation object.
 *
 * @return @a r_2_d_relative_location.
 */
...
/** Move a value to the orientationAngle field in a r_2DRelativeLocation object
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 *
 * @param r_2_d_relative_location The r_2DRelativeLocation object to set the field in.
 * @param p_orientation_angle The value to move into the r_2DRelativeLocation object.
 *
 * @return @a r_2_d_relative_location.
 */
 ...
 * \public \memberof data_collection_model_r_2_d_relative_location_t
 *
 * Creates a new data_collection_lnode_t object containing the @a r_2_d_relative_location object.
 * The @a r_2_d_relative_location will be deleted when the data_collection_lnode_t is freed. Use
 * data_collection_lnode_create_ref() if you want an list node that will not delete the object when it is freed.
 *
 * @param r_2_d_relative_location The r_2DRelativeLocation object to create an data_collection_lnode_t object for.
 *
 * @return a new data_collection_lnode_t object containing the @a r_2_d_relative_location
 */
