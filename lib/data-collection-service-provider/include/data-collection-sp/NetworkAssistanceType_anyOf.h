...
typedef struct data_collection_model_network_assistance_type_any_of_s data_collection_model_network_assistance_type_any_of_t;

typedef enum {
    DCM_NETWORK_ASSISTANCE_TYPE_ANY_OF_NO_VAL,
    DCM_NETWORK_ASSISTANCE_TYPE_ANY_OF_VAL_AF_THROUGHPUT_ESTIMATION,
    DCM_NETWORK_ASSISTANCE_TYPE_ANY_OF_VAL_AF_DELIVERY_BOOST,
    DCM_NETWORK_ASSISTANCE_TYPE_ANY_OF_VAL_ANBR_THROUGHPUT_ESTIMATION,
    DCM_NETWORK_ASSISTANCE_TYPE_ANY_OF_VAL_ANBR_DELIVERY_BOOST
