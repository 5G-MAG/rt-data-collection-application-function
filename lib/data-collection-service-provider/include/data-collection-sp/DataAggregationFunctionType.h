...
typedef struct data_collection_model_data_aggregation_function_type_s data_collection_model_data_aggregation_function_type_t;

typedef enum {
    DCM_DATA_AGGREGATION_FUNCTION_TYPE_NO_VAL,
    DCM_DATA_AGGREGATION_FUNCTION_TYPE_VAL_NONE,
    DCM_DATA_AGGREGATION_FUNCTION_TYPE_VAL_COUNT,
    DCM_DATA_AGGREGATION_FUNCTION_TYPE_VAL_MEAN,
    DCM_DATA_AGGREGATION_FUNCTION_TYPE_VAL_MAXIMUM,
    DCM_DATA_AGGREGATION_FUNCTION_TYPE_VAL_MINIMUM,
    DCM_DATA_AGGREGATION_FUNCTION_TYPE_VAL_SUM,
    DCM_DATA_AGGREGATION_FUNCTION_TYPE_OTHER
