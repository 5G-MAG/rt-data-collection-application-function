...
typedef struct data_collection_model_provisioning_session_type_any_of_s data_collection_model_provisioning_session_type_any_of_t;

typedef enum {
    DCM_PROVISIONING_SESSION_TYPE_ANY_OF_NO_VAL,
    DCM_PROVISIONING_SESSION_TYPE_ANY_OF_VAL_MS_DOWNLINK,
    DCM_PROVISIONING_SESSION_TYPE_ANY_OF_VAL_MS_UPLINK,
    DCM_PROVISIONING_SESSION_TYPE_ANY_OF_VAL_RTC
