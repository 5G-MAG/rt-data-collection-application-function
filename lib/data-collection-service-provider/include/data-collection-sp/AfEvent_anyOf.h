...
typedef struct data_collection_model_af_event_any_of_s data_collection_model_af_event_any_of_t;

typedef enum {
    DCM_AF_EVENT_ANY_OF_NO_VAL,
    DCM_AF_EVENT_ANY_OF_VAL_SVC_EXPERIENCE,
    DCM_AF_EVENT_ANY_OF_VAL_UE_MOBILITY,
    DCM_AF_EVENT_ANY_OF_VAL_UE_COMM,
    DCM_AF_EVENT_ANY_OF_VAL_EXCEPTIONS,
    DCM_AF_EVENT_ANY_OF_VAL_USER_DATA_CONGESTION,
    DCM_AF_EVENT_ANY_OF_VAL_PERF_DATA,
    DCM_AF_EVENT_ANY_OF_VAL_DISPERSION,
    DCM_AF_EVENT_ANY_OF_VAL_COLLECTIVE_BEHAVIOUR,
    DCM_AF_EVENT_ANY_OF_VAL_MS_QOE_METRICS,
    DCM_AF_EVENT_ANY_OF_VAL_MS_CONSUMPTION,
    DCM_AF_EVENT_ANY_OF_VAL_MS_NET_ASSIST_INVOCATION,
    DCM_AF_EVENT_ANY_OF_VAL_MS_DYN_POLICY_INVOCATION,
    DCM_AF_EVENT_ANY_OF_VAL_MS_ACCESS_ACTIVITY,
    DCM_AF_EVENT_ANY_OF_VAL_GNSS_ASSISTANCE_DATA,
    DCM_AF_EVENT_ANY_OF_VAL_DATA_VOLUME_TRANSFER_TIME
