...
typedef struct data_collection_model_battery_indication_any_of_s data_collection_model_battery_indication_any_of_t;

typedef enum {
    DCM_BATTERY_INDICATION_ANY_OF_NO_VAL,
    DCM_BATTERY_INDICATION_ANY_OF_VAL_BATTERY_RECHARGE,
    DCM_BATTERY_INDICATION_ANY_OF_VAL_BATTERY_REPLACE,
    DCM_BATTERY_INDICATION_ANY_OF_VAL_BATTERY_NO_RECHARGE,
    DCM_BATTERY_INDICATION_ANY_OF_VAL_BATTERY_NO_REPLACE,
    DCM_BATTERY_INDICATION_ANY_OF_VAL_NO_BATTERY
