...
/** A 3GPP DataCollectionClientType object reference
 */
typedef struct data_collection_model_data_collection_client_type_s
#ifdef DOXYGEN_ONLY
{
    int dummy; /**< \private placeholder */
}
#endif
data_collection_model_data_collection_client_type_t;


/** DataCollectionClientType enumerated values */
typedef enum {
    DCM_DATA_COLLECTION_CLIENT_TYPE_NO_VAL, /**< No value */
    DCM_DATA_COLLECTION_CLIENT_TYPE_VAL_DIRECT, /**< DIRECT */
    DCM_DATA_COLLECTION_CLIENT_TYPE_VAL_INDIRECT, /**< INDIRECT */
    DCM_DATA_COLLECTION_CLIENT_TYPE_VAL_APPLICATION_SERVER, /**< APPLICATION_SERVER */
    DCM_DATA_COLLECTION_CLIENT_TYPE_OTHER  /**< Custom value (future expansion) */
...
/** Create a new reference of a DataCollectionClientType object
 * \public \memberof data_collection_model_data_collection_client_type_t
 * Creates a reference to the same underlying @a other object.
 * @param other The DataCollectionClientType to create a new reference to.
 * @return a new DataCollectionClientType object pointer reference.
 */
...
/** Copy the value of another DataCollectionClientType into this object
 * \public \memberof data_collection_model_data_collection_client_type_t
 * Copies the value of @a other {{classname} object into @a data_collection_client_type.
 * @param data_collection_client_type The DataCollectionClientType object to copy @a other into.
 * @param other The DataCollectionClientType to copy the value from.
 * @return @a data_collection_client_type.
 */
...
/** Move the value of another DataCollectionClientType into this object
 * \public \memberof data_collection_model_data_collection_client_type_t
 * Discards the current value of @a data_collection_client_type and moves the value of @a other
 * into @a data_collection_client_type. This will leave @a other as an empty reference.
 *
 * @param data_collection_client_type The DataCollectionClientType object to move @a other into.
 * @param other The DataCollectionClientType to move the value from.
 *
 * @return @a data_collection_client_type.
 */
...
/** Delete a DataCollectionClientType object
 * \public \memberof data_collection_model_data_collection_client_type_t
 * Destroys the reference to the DataCollectionClientType object and frees the value of DataCollectionClientType if this is the last reference.
 *
 * @param data_collection_client_type The DataCollectionClientType to free.
 */
...
/** Get a cJSON tree representation of a DataCollectionClientType
 * \public \memberof data_collection_model_data_collection_client_type_t
 *
 * Create a cJSON tree representation of the DataCollectionClientType object as either an API request or response. This respects fields marked
 * as Read-only (only in responses) or Write-only (only in requests) in the OpenAPI model description. The resulting cJSON tree
 * must be freed by the caller using the cJSON_Delete() function.
 *
 * @param data_collection_client_type The DataCollectionClientType to represent as a cJSON tree.
...
/** Parse a cJSON tree into a DataCollectionClientType object
 * \public \memberof data_collection_model_data_collection_client_type_t
 *
 * Attempts to interpret a cJSON tree as a DataCollectionClientType API request or response (dependent on @a as_request value). If successful
 * will return a new referenced DataCollectionClientType object containing the value represented by the cJSON tree. On failure will return
 ...
 * @param[out] error_parameter On failure will be set to the JSON path of the field where the failure happened if available or
                               `NULL`.
 *
 * @return a new DataCollectionClientType object or `NULL` if the parsing failed.
 */
...
/** Compare two DataCollectionClientType objects to see if they are equivalent
 * \public \memberof data_collection_model_data_collection_client_type_t
 *
 * This will return `true` if the two objects are referencing the same object or the two objects have the same value.
 *
 * @param data_collection_client_type The first DataCollectionClientType object to compare.
 * @param other_data_collection_client_type The second DataCollectionClientType object to compare.
 *
...
/** Check if the DataCollectionClientType enumeration object has a value set
 * \public \memberof data_collection_model_data_collection_client_type_t
 *
 * @param data_collection_client_type The DataCollectionClientType enumeration object to check.
...
/** Check if the DataCollectionClientType enumeration object has a custom value set
 * \public \memberof data_collection_model_data_collection_client_type_t
 *
 * @param data_collection_client_type The DataCollectionClientType enumeration object to check.
...
/** Get the enumeration value for a DataCollectionClientType object
 * \public \memberof data_collection_model_data_collection_client_type_t
 *
 * @param data_collection_client_type The DataCollectionClientType object to extract the enumeration value from.
 *
 * @return the data_collection_model_data_collection_client_type_e value represented by the DataCollectionClientType object.
 */
...
/** Get the string representation of the enumeration value for a DataCollectionClientType object
 * \public \memberof data_collection_model_data_collection_client_type_t
 *
 * @param data_collection_client_type The DataCollectionClientType object to extract the enumeration value from.
 *
...
/** Set the enumeration value for a DataCollectionClientType object
 * \public \memberof data_collection_model_data_collection_client_type_t
 *
 * @param data_collection_client_type The DataCollectionClientType object to set the enumeration value for.
...
/** Set the enumeration value as a string for a DataCollectionClientType object
 * \public \memberof data_collection_model_data_collection_client_type_t
 *
 * Sets the enumeration value from the string given. If the string is a non-standard, custom value then the
 * data_collection_model_data_collection_client_type_get_enum
 * function will return DCM_DATA_COLLECTION_CLIENT_TYPE_OTHER
 ...
 * \public \memberof data_collection_model_data_collection_client_type_t
 *
 * Creates a new data_collection_lnode_t object containing the @a data_collection_client_type object.
 * The @a data_collection_client_type will be deleted when the data_collection_lnode_t is freed. Use
 * data_collection_lnode_create_ref() if you want an list node that will not delete the object when it is freed.
 *
 * @param data_collection_client_type The DataCollectionClientType object to create an data_collection_lnode_t object for.
 *
 * @return a new data_collection_lnode_t object containing the @a data_collection_client_type
 */
