...
typedef struct data_collection_model_cp_failure_code_any_of_s data_collection_model_cp_failure_code_any_of_t;

typedef enum {
    DCM_CP_FAILURE_CODE_ANY_OF_NO_VAL,
    DCM_CP_FAILURE_CODE_ANY_OF_VAL_MALFUNCTION,
    DCM_CP_FAILURE_CODE_ANY_OF_VAL_SET_ID_DUPLICATED,
    DCM_CP_FAILURE_CODE_ANY_OF_VAL_OTHER_REASON,
    DCM_CP_FAILURE_CODE_ANY_OF_VAL_CONFIDENCE_LEVEL_NOT_SUFFICIENT,
    DCM_CP_FAILURE_CODE_ANY_OF_VAL_ACCURACY_LEVEL_NOT_SUFFICIENT
