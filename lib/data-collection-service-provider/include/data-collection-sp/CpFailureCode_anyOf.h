...
/** Create a new CpFailureCode_anyOf reference.
 * \public \memberof data_collection_model_cp_failure_code_any_of_t
 * Creates a new reference to the same underlying object as \a other.
 * @param other The CpFailureCode_anyOf to create a new reference to.
 * @return a new reference to the underlying object of \a other.
 */
DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_cp_failure_code_any_of_t *data_collection_model_cp_failure_code_any_of_create_ref(const data_collection_model_cp_failure_code_any_of_t *other);
