...
typedef struct data_collection_model_cell_identifier_type_s data_collection_model_cell_identifier_type_t;

typedef enum {
    DCM_CELL_IDENTIFIER_TYPE_NO_VAL,
    DCM_CELL_IDENTIFIER_TYPE_VAL_CGI,
    DCM_CELL_IDENTIFIER_TYPE_VAL_ECGI,
    DCM_CELL_IDENTIFIER_TYPE_VAL_NCGI,
    DCM_CELL_IDENTIFIER_TYPE_OTHER
