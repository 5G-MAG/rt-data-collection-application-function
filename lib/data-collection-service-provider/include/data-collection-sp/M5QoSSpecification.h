...
/** A 3GPP M5QoSSpecification object reference
 */
typedef struct data_collection_model_m5_qo_s_specification_s
#ifdef DOXYGEN_ONLY
{
...
/** Create a new M5QoSSpecification
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 * @return a new M5QoSSpecification object pointer.
 */
...
/** Create a new copy of a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 * Creates a new copy of the given @a other object
 * @param other The M5QoSSpecification to copy.
 * @return a new M5QoSSpecification object pointer.
 */
...
/** Create a new reference of a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 * Creates a reference to the same underlying @a other object.
 * @param other The M5QoSSpecification to create a new reference to.
 * @return a new M5QoSSpecification object pointer reference.
 */
...
/** Copy the value of another M5QoSSpecification into this object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 * Copies the value of @a other {{classname} object into @a m5_qo_s_specification.
 * @param m5_qo_s_specification The M5QoSSpecification object to copy @a other into.
 * @param other The M5QoSSpecification to copy the value from.
 * @return @a m5_qo_s_specification.
 */
...
/** Move the value of another M5QoSSpecification into this object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 * Discards the current value of @a m5_qo_s_specification and moves the value of @a other
 * into @a m5_qo_s_specification. This will leave @a other as an empty reference.
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to move @a other into.
 * @param other The M5QoSSpecification to move the value from.
 *
 * @return @a m5_qo_s_specification.
 */
...
/** Delete a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 * Destroys the reference to the M5QoSSpecification object and frees the value of M5QoSSpecification if this is the last reference.
 *
 * @param m5_qo_s_specification The M5QoSSpecification to free.
 */
...
/** Get a cJSON tree representation of a M5QoSSpecification
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * Create a cJSON tree representation of the M5QoSSpecification object as either an API request or response. This respects fields marked
 * as Read-only (only in responses) or Write-only (only in requests) in the OpenAPI model description. The resulting cJSON tree
 * must be freed by the caller using the cJSON_Delete() function.
 *
 * @param m5_qo_s_specification The M5QoSSpecification to represent as a cJSON tree.
...
/** Parse a cJSON tree into a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * Attempts to interpret a cJSON tree as a M5QoSSpecification API request or response (dependent on @a as_request value). If successful
 * will return a new referenced M5QoSSpecification object containing the value represented by the cJSON tree. On failure will return
 ...
 * @param[out] error_parameter On failure will be set to the JSON path of the field where the failure happened if available or
                               `NULL`.
 *
 * @return a new M5QoSSpecification object or `NULL` if the parsing failed.
 */
...
/** Compare two M5QoSSpecification objects to see if they are equivalent
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * This will return `true` if the two objects are referencing the same object or the two objects have the same value.
 *
 * @param m5_qo_s_specification The first M5QoSSpecification object to compare.
 * @param other_m5_qo_s_specification The second M5QoSSpecification object to compare.
 *
...
/** Get the value of the downlinkBitRates field of a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to examine.
 *
...
/** Set the value of the downlinkBitRates field in a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to set the field in.
 * @param p_downlink_bit_rates The value to copy into the M5QoSSpecification object.
 *
 * @return @a m5_qo_s_specification.
 */
...
/** Move a value to the downlinkBitRates field in a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to set the field in.
 * @param p_downlink_bit_rates The value to move into the M5QoSSpecification object.
 *
 * @return @a m5_qo_s_specification.
 */
...
/** Get the value of the uplinkBitRates field of a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to examine.
 *
...
/** Set the value of the uplinkBitRates field in a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to set the field in.
 * @param p_uplink_bit_rates The value to copy into the M5QoSSpecification object.
 *
 * @return @a m5_qo_s_specification.
 */
...
/** Move a value to the uplinkBitRates field in a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to set the field in.
 * @param p_uplink_bit_rates The value to move into the M5QoSSpecification object.
 *
 * @return @a m5_qo_s_specification.
 */
...
/** Check if the desiredPacketLatency field of a M5QoSSpecification object is set
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to examine.
 *
...
/** Get the value of the desiredPacketLatency field of a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to examine.
 *
...
/** Set the value of the desiredPacketLatency field in a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to set the field in.
 * @param p_desired_packet_latency The value to copy into the M5QoSSpecification object.
 *
 * @return @a m5_qo_s_specification.
 */
...
/** Move a value to the desiredPacketLatency field in a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to set the field in.
 * @param p_desired_packet_latency The value to move into the M5QoSSpecification object.
 *
 * @return @a m5_qo_s_specification.
 */
...
/** Check if the desiredPacketLossRate field of a M5QoSSpecification object is set
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to examine.
 *
...
/** Get the value of the desiredPacketLossRate field of a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to examine.
 *
...
/** Set the value of the desiredPacketLossRate field in a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to set the field in.
 * @param p_desired_packet_loss_rate The value to copy into the M5QoSSpecification object.
 *
 * @return @a m5_qo_s_specification.
 */
...
/** Move a value to the desiredPacketLossRate field in a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to set the field in.
 * @param p_desired_packet_loss_rate The value to move into the M5QoSSpecification object.
 *
 * @return @a m5_qo_s_specification.
 */
...
/** Check if the desiredDownlinkPduSetQosParameters field of a M5QoSSpecification object is set
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to examine.
 *
...
/** Get the value of the desiredDownlinkPduSetQosParameters field of a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to examine.
 *
...
/** Set the value of the desiredDownlinkPduSetQosParameters field in a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to set the field in.
 * @param p_desired_downlink_pdu_set_qos_parameters The value to copy into the M5QoSSpecification object.
 *
 * @return @a m5_qo_s_specification.
 */
...
/** Move a value to the desiredDownlinkPduSetQosParameters field in a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to set the field in.
 * @param p_desired_downlink_pdu_set_qos_parameters The value to move into the M5QoSSpecification object.
 *
 * @return @a m5_qo_s_specification.
 */
...
/** Check if the desiredUplinkPduSetQosParameters field of a M5QoSSpecification object is set
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to examine.
 *
...
/** Get the value of the desiredUplinkPduSetQosParameters field of a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to examine.
 *
...
/** Set the value of the desiredUplinkPduSetQosParameters field in a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to set the field in.
 * @param p_desired_uplink_pdu_set_qos_parameters The value to copy into the M5QoSSpecification object.
 *
 * @return @a m5_qo_s_specification.
 */
...
/** Move a value to the desiredUplinkPduSetQosParameters field in a M5QoSSpecification object
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to set the field in.
 * @param p_desired_uplink_pdu_set_qos_parameters The value to move into the M5QoSSpecification object.
 *
 * @return @a m5_qo_s_specification.
 */
 ...
 * \public \memberof data_collection_model_m5_qo_s_specification_t
 *
 * Creates a new data_collection_lnode_t object containing the @a m5_qo_s_specification object.
 * The @a m5_qo_s_specification will be deleted when the data_collection_lnode_t is freed. Use
 * data_collection_lnode_create_ref() if you want an list node that will not delete the object when it is freed.
 *
 * @param m5_qo_s_specification The M5QoSSpecification object to create an data_collection_lnode_t object for.
 *
 * @return a new data_collection_lnode_t object containing the @a m5_qo_s_specification
 */
