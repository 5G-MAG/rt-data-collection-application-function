...
typedef struct data_collection_model_scheduled_communication_type_s data_collection_model_scheduled_communication_type_t;

typedef enum {
    DCM_SCHEDULED_COMMUNICATION_TYPE_NO_VAL,
    DCM_SCHEDULED_COMMUNICATION_TYPE_VAL_DOWNLINK,
    DCM_SCHEDULED_COMMUNICATION_TYPE_VAL_UPLINK,
    DCM_SCHEDULED_COMMUNICATION_TYPE_VAL_BIDIRECTIONAL,
    DCM_SCHEDULED_COMMUNICATION_TYPE_OTHER
