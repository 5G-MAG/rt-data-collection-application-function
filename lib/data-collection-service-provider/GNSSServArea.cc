...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_gnss_serv_area_t *data_collection_model_gnss_serv_area_create_ref(const data_collection_model_gnss_serv_area_t *other)
{
    return reinterpret_cast<data_collection_model_gnss_serv_area_t*>(new std::shared_ptr<GNSSServArea>(*reinterpret_cast<const std::shared_ptr<GNSSServArea >*>(other)));
}
