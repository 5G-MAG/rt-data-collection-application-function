...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_eth_flow_description_t *data_collection_model_eth_flow_description_create_ref(const data_collection_model_eth_flow_description_t *other)
{
    return reinterpret_cast<data_collection_model_eth_flow_description_t*>(new std::shared_ptr<EthFlowDescription>(*reinterpret_cast<const std::shared_ptr<EthFlowDescription >*>(other)));
}
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const char* data_collection_model_eth_flow_description_get_entry_vlan_tags(const data_collection_model_eth_flow_description_t *obj_eth_flow_description, size_t idx)
{
    if (!obj_eth_flow_description) {
        const char *result = NULL;
    ...
    const EthFlowDescription::VlanTagsType &container = obj->getVlanTags();
    ...
    typedef typename EthFlowDescription::VlanTagsItemType ResultFromType;
