...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_user_data_congestion_collection_t *data_collection_model_user_data_congestion_collection_create_ref(const data_collection_model_user_data_congestion_collection_t *other)
{
    return reinterpret_cast<data_collection_model_user_data_congestion_collection_t*>(new std::shared_ptr<UserDataCongestionCollection>(*reinterpret_cast<const std::shared_ptr<UserDataCongestionCollection >*>(other)));
}
