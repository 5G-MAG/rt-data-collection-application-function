...
{
    return reinterpret_cast<data_collection_model_af_event_notification_t*>(new std::shared_ptr<AfEventNotification >(new AfEventNotification(**reinterpret_cast<const std::shared_ptr<AfEventNotification >*>(other))));
}
...
{
    return reinterpret_cast<data_collection_model_af_event_notification_t*>(new std::shared_ptr<AfEventNotification >(std::move(*reinterpret_cast<std::shared_ptr<AfEventNotification >*>(other))));
}
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_af_event_notification_t *data_collection_model_af_event_notification_copy(data_collection_model_af_event_notification_t *af_event_notification, const data_collection_model_af_event_notification_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<AfEventNotification >*>(other);
...
{
    std::shared_ptr<AfEventNotification > &obj = *reinterpret_cast<std::shared_ptr<AfEventNotification >*>(af_event_notification);
    obj = std::move(*reinterpret_cast<std::shared_ptr<AfEventNotification >*>(other));
    return af_event_notification;
}
...
{
    if (obj_af_event_notification == NULL) return NULL;
