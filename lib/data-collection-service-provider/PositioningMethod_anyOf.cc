...
{
    return reinterpret_cast<data_collection_model_positioning_method_any_of_t*>(new std::shared_ptr<PositioningMethod_anyOf >(new PositioningMethod_anyOf(**reinterpret_cast<const std::shared_ptr<PositioningMethod_anyOf >*>(other))));
}
...
{
    return reinterpret_cast<data_collection_model_positioning_method_any_of_t*>(new std::shared_ptr<PositioningMethod_anyOf >(std::move(*reinterpret_cast<std::shared_ptr<PositioningMethod_anyOf >*>(other))));
}
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_positioning_method_any_of_t *data_collection_model_positioning_method_any_of_copy(data_collection_model_positioning_method_any_of_t *positioning_method_any_of, const data_collection_model_positioning_method_any_of_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<PositioningMethod_anyOf >*>(other);
...
{
    std::shared_ptr<PositioningMethod_anyOf > &obj = *reinterpret_cast<std::shared_ptr<PositioningMethod_anyOf >*>(positioning_method_any_of);
    obj = std::move(*reinterpret_cast<std::shared_ptr<PositioningMethod_anyOf >*>(other));
    return positioning_method_any_of;
}
