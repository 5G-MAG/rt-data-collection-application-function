...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_positioning_method_any_of_t *data_collection_model_positioning_method_any_of_create()
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_positioning_method_any_of_t *data_collection_model_positioning_method_any_of_create_ref(const data_collection_model_positioning_method_any_of_t *other)
{
    return reinterpret_cast<data_collection_model_positioning_method_any_of_t*>(new std::shared_ptr<PositioningMethod_anyOf>(*reinterpret_cast<const std::shared_ptr<PositioningMethod_anyOf >*>(other)));
}

extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_positioning_method_any_of_t *data_collection_model_positioning_method_any_of_create_copy(const data_collection_model_positioning_method_any_of_t *other)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_positioning_method_any_of_t *data_collection_model_positioning_method_any_of_create_move(data_collection_model_positioning_method_any_of_t *other)
{
    if (!other) return NULL;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_positioning_method_any_of_t *data_collection_model_positioning_method_any_of_copy(data_collection_model_positioning_method_any_of_t *positioning_method_any_of, const data_collection_model_positioning_method_any_of_t *other)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_positioning_method_any_of_t *data_collection_model_positioning_method_any_of_move(data_collection_model_positioning_method_any_of_t *positioning_method_any_of, data_collection_model_positioning_method_any_of_t *other)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API void data_collection_model_positioning_method_any_of_free(data_collection_model_positioning_method_any_of_t *positioning_method_any_of)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API cJSON *data_collection_model_positioning_method_any_of_toJSON(const data_collection_model_positioning_method_any_of_t *positioning_method_any_of, bool as_request)
{
    ...
    if (obj) {
        try {
            ...
            ogs_error("Failed to convert data_collection_model_positioning_method_any_of_t to cJSON [%s.%s]: %s", err.classname.c_str(), err.parameter.c_str(), err.what());
        }
    }
    return NULL;
}

extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_positioning_method_any_of_t *data_collection_model_positioning_method_any_of_fromJSON(cJSON *json, bool as_request, char **error_reason, char **error_class, char **error_parameter)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_positioning_method_any_of_is_equal_to(const data_collection_model_positioning_method_any_of_t *first, const data_collection_model_positioning_method_any_of_t *second)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_positioning_method_any_of_is_not_set(const data_collection_model_positioning_method_any_of_t *positioning_method_any_of)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_positioning_method_any_of_e data_collection_model_positioning_method_any_of_get_enum(const data_collection_model_positioning_method_any_of_t *obj_positioning_method_any_of)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const char *data_collection_model_positioning_method_any_of_get_string(const data_collection_model_positioning_method_any_of_t *obj_positioning_method_any_of)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_positioning_method_any_of_set_enum(data_collection_model_positioning_method_any_of_t *obj_positioning_method_any_of, data_collection_model_positioning_method_any_of_e p_value)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_positioning_method_any_of_set_string(data_collection_model_positioning_method_any_of_t *obj_positioning_method_any_of, const char *p_value)
{
    if (!obj_positioning_method_any_of) return false;
    std::shared_ptr<PositioningMethod_anyOf > &obj = *reinterpret_cast<std::shared_ptr<PositioningMethod_anyOf >*>(obj_positioning_method_any_of);
    if (!obj) return false;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_lnode_t *data_collection_model_positioning_method_any_of_make_lnode(data_collection_model_positioning_method_any_of_t *p_positioning_method_any_of)
{
