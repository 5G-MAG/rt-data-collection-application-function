...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_media_streaming_accesses_collection_t *data_collection_model_media_streaming_accesses_collection_create(
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_media_streaming_accesses_collection_t *data_collection_model_media_streaming_accesses_collection_create_ref(const data_collection_model_media_streaming_accesses_collection_t *other)
{
    return reinterpret_cast<data_collection_model_media_streaming_accesses_collection_t*>(new std::shared_ptr<MediaStreamingAccessesCollection>(*reinterpret_cast<const std::shared_ptr<MediaStreamingAccessesCollection >*>(other)));
}

extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_media_streaming_accesses_collection_t *data_collection_model_media_streaming_accesses_collection_create_copy(const data_collection_model_media_streaming_accesses_collection_t *other)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_media_streaming_accesses_collection_t *data_collection_model_media_streaming_accesses_collection_create_move(data_collection_model_media_streaming_accesses_collection_t *other)
{
    if (!other) return NULL;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API void data_collection_model_media_streaming_accesses_collection_free(data_collection_model_media_streaming_accesses_collection_t *media_streaming_accesses_collection)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API cJSON *data_collection_model_media_streaming_accesses_collection_toJSON(const data_collection_model_media_streaming_accesses_collection_t *media_streaming_accesses_collection, bool as_request)
{
    ...
    if (obj) {
        try {
            ...
            ogs_error("Failed to convert data_collection_model_media_streaming_accesses_collection_t to cJSON [%s.%s]: %s", err.classname.c_str(), err.parameter.c_str(), err.what());
        }
    }
    return NULL;
}

extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_media_streaming_accesses_collection_t *data_collection_model_media_streaming_accesses_collection_fromJSON(cJSON *json, bool as_request, char **error_reason, char **error_class, char **error_parameter)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_media_streaming_accesses_collection_is_equal_to(const data_collection_model_media_streaming_accesses_collection_t *first, const data_collection_model_media_streaming_accesses_collection_t *second)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const char* data_collection_model_media_streaming_accesses_collection_get_collection_timestamp(const data_collection_model_media_streaming_accesses_collection_t *obj_media_streaming_accesses_collection)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const char* data_collection_model_media_streaming_accesses_collection_get_start_timestamp(const data_collection_model_media_streaming_accesses_collection_t *obj_media_streaming_accesses_collection)
{
    if (!obj_media_streaming_accesses_collection) {
        const char *result = NULL;
        return result;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const char* data_collection_model_media_streaming_accesses_collection_get_end_timestamp(const data_collection_model_media_streaming_accesses_collection_t *obj_media_streaming_accesses_collection)
{
    if (!obj_media_streaming_accesses_collection) {
        const char *result = NULL;
        return result;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const int32_t data_collection_model_media_streaming_accesses_collection_get_sample_count(const data_collection_model_media_streaming_accesses_collection_t *obj_media_streaming_accesses_collection)
{
    if (!obj_media_streaming_accesses_collection) {
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const data_collection_model_provisioning_session_type_t* data_collection_model_media_streaming_accesses_collection_get_streaming_direction(const data_collection_model_media_streaming_accesses_collection_t *obj_media_streaming_accesses_collection)
{
    if (!obj_media_streaming_accesses_collection) {
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API ogs_list_t* data_collection_model_media_streaming_accesses_collection_get_summarisations(const data_collection_model_media_streaming_accesses_collection_t *obj_media_streaming_accesses_collection)
{
    if (!obj_media_streaming_accesses_collection) {
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const data_collection_model_data_aggregation_function_type_t* data_collection_model_media_streaming_accesses_collection_get_entry_summarisations(const data_collection_model_media_streaming_accesses_collection_t *obj_media_streaming_accesses_collection, size_t idx)
{
    if (!obj_media_streaming_accesses_collection) {
    ...
    const MediaStreamingAccessesCollection::SummarisationsType &container = obj->getSummarisations();
    ...
    typedef typename MediaStreamingAccessesCollection::SummarisationsItemType ResultFromType;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_media_streaming_accesses_collection_t *data_collection_model_media_streaming_accesses_collection_clear_summarisations(data_collection_model_media_streaming_accesses_collection_t *obj_media_streaming_accesses_collection)
{
    if (!obj_media_streaming_accesses_collection) return NULL;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API ogs_list_t* data_collection_model_media_streaming_accesses_collection_get_records(const data_collection_model_media_streaming_accesses_collection_t *obj_media_streaming_accesses_collection)
{
    if (!obj_media_streaming_accesses_collection) {
        ogs_list_t *result = NULL;
        return result;
    ...
    for (const ItemType &item : result_from) {
        data_collection_lnode_t *node = nullptr;
        data_collection_model_media_streaming_access_event_t *item_obj = reinterpret_cast<data_collection_model_media_streaming_access_event_t*>(item.has_value()?new std::shared_ptr<MediaStreamingAccessEvent >(item.value()):nullptr);
        if (item_obj) {
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_media_streaming_accesses_collection_t *data_collection_model_media_streaming_accesses_collection_set_records(data_collection_model_media_streaming_accesses_collection_t *obj_media_streaming_accesses_collection, const ogs_list_t* p_records)
{
    if (!obj_media_streaming_accesses_collection) return NULL;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_media_streaming_accesses_collection_t *data_collection_model_media_streaming_accesses_collection_set_records_move(data_collection_model_media_streaming_accesses_collection_t *obj_media_streaming_accesses_collection, ogs_list_t* p_records)
{
    if (!obj_media_streaming_accesses_collection) return NULL;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const data_collection_model_media_streaming_access_event_t* data_collection_model_media_streaming_accesses_collection_get_entry_records(const data_collection_model_media_streaming_accesses_collection_t *obj_media_streaming_accesses_collection, size_t idx)
{
    if (!obj_media_streaming_accesses_collection) {
    ...
    const MediaStreamingAccessesCollection::RecordsType &container = obj->getRecords();
    ...
    typedef typename MediaStreamingAccessesCollection::RecordsItemType ResultFromType;
    const ResultFromType &result_from = *itr;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_media_streaming_accesses_collection_t *data_collection_model_media_streaming_accesses_collection_clear_records(data_collection_model_media_streaming_accesses_collection_t *obj_media_streaming_accesses_collection)
{
    if (!obj_media_streaming_accesses_collection) return NULL;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_lnode_t *data_collection_model_media_streaming_accesses_collection_make_lnode(data_collection_model_media_streaming_accesses_collection_t *p_media_streaming_accesses_collection)
{
