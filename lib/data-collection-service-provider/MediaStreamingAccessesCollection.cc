...
{
    return reinterpret_cast<data_collection_model_media_streaming_accesses_collection_t*>(new std::shared_ptr<MediaStreamingAccessesCollection >(new MediaStreamingAccessesCollection(**reinterpret_cast<const std::shared_ptr<MediaStreamingAccessesCollection >*>(other))));
}
...
{
    return reinterpret_cast<data_collection_model_media_streaming_accesses_collection_t*>(new std::shared_ptr<MediaStreamingAccessesCollection >(std::move(*reinterpret_cast<std::shared_ptr<MediaStreamingAccessesCollection >*>(other))));
}
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_media_streaming_accesses_collection_t *data_collection_model_media_streaming_accesses_collection_copy(data_collection_model_media_streaming_accesses_collection_t *media_streaming_accesses_collection, const data_collection_model_media_streaming_accesses_collection_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<MediaStreamingAccessesCollection >*>(other);
...
{
    std::shared_ptr<MediaStreamingAccessesCollection > &obj = *reinterpret_cast<std::shared_ptr<MediaStreamingAccessesCollection >*>(media_streaming_accesses_collection);
    obj = std::move(*reinterpret_cast<std::shared_ptr<MediaStreamingAccessesCollection >*>(other));
    return media_streaming_accesses_collection;
}
...
{
    if (obj_media_streaming_accesses_collection == NULL) return NULL;
