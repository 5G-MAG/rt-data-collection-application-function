...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_polygon_t *data_collection_model_polygon_create_ref(const data_collection_model_polygon_t *other)
{
    return reinterpret_cast<data_collection_model_polygon_t*>(new std::shared_ptr<Polygon>(*reinterpret_cast<const std::shared_ptr<Polygon >*>(other)));
}
