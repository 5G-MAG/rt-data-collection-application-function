...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_network_assistance_invocation_event_t *data_collection_model_network_assistance_invocation_event_create_ref(const data_collection_model_network_assistance_invocation_event_t *other)
{
    return reinterpret_cast<data_collection_model_network_assistance_invocation_event_t*>(new std::shared_ptr<NetworkAssistanceInvocationEvent>(*reinterpret_cast<const std::shared_ptr<NetworkAssistanceInvocationEvent >*>(other)));
}
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API cJSON *data_collection_model_network_assistance_invocation_event_toJSON(const data_collection_model_network_assistance_invocation_event_t *network_assistance_invocation_event, bool as_request)
{
    ...
    if (obj) {
        try {
            ...
            ogs_error("Failed to convert data_collection_model_network_assistance_invocation_event_t to cJSON [%s.%s]: %s", err.classname.c_str(), err.parameter.c_str(), err.what());
        }
    }
    return NULL;
}
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const data_collection_model_location_area5_g_t* data_collection_model_network_assistance_invocation_event_get_entry_ue_locations(const data_collection_model_network_assistance_invocation_event_t *obj_network_assistance_invocation_event, size_t idx)
{
    if (!obj_network_assistance_invocation_event) {
    ...
    const NetworkAssistanceInvocationEvent::UeLocationsType &container = obj->getUeLocations();
    ...
    typedef typename NetworkAssistanceInvocationEvent::UeLocationsItemType ResultFromType;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const data_collection_model_application_flow_description_t* data_collection_model_network_assistance_invocation_event_get_entry_application_flow_descriptions(const data_collection_model_network_assistance_invocation_event_t *obj_network_assistance_invocation_event, size_t idx)
{
    if (!obj_network_assistance_invocation_event) {
    ...
    const NetworkAssistanceInvocationEvent::ApplicationFlowDescriptionsType &container = obj->getApplicationFlowDescriptions();
    if (!container.has_value()) {
        const data_collection_model_application_flow_description_t *result = NULL;
    ...
    typedef typename NetworkAssistanceInvocationEvent::ApplicationFlowDescriptionsItemType ResultFromType;
    const ResultFromType &result_from = *itr;
