...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_performance_data_collection_t *data_collection_model_performance_data_collection_create_ref(const data_collection_model_performance_data_collection_t *other)
{
    return reinterpret_cast<data_collection_model_performance_data_collection_t*>(new std::shared_ptr<PerformanceDataCollection>(*reinterpret_cast<const std::shared_ptr<PerformanceDataCollection >*>(other)));
}
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API cJSON *data_collection_model_performance_data_collection_toJSON(const data_collection_model_performance_data_collection_t *performance_data_collection, bool as_request)
{
    ...
    if (obj) {
        try {
            ...
            ogs_error("Failed to convert data_collection_model_performance_data_collection_t to cJSON [%s.%s]: %s", err.classname.c_str(), err.parameter.c_str(), err.what());
        }
    }
    return NULL;
}
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const char* data_collection_model_performance_data_collection_get_entry_app_locs(const data_collection_model_performance_data_collection_t *obj_performance_data_collection, size_t idx)
{
    if (!obj_performance_data_collection) {
        const char *result = NULL;
    ...
    const PerformanceDataCollection::AppLocsType &container = obj->getAppLocs();
    ...
    typedef typename PerformanceDataCollection::AppLocsItemType ResultFromType;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_performance_data_collection_t *data_collection_model_performance_data_collection_set_perf_data_move(data_collection_model_performance_data_collection_t *obj_performance_data_collection, data_collection_model_performance_data_t* p_perf_data)
{
    ...
    data_collection_model_performance_data_free
(p_perf_data);
