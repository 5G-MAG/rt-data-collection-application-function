...
{
    return reinterpret_cast<data_collection_model_qo_e_metrics_event_t*>(new std::shared_ptr<QoEMetricsEvent >(new QoEMetricsEvent(**reinterpret_cast<const std::shared_ptr<QoEMetricsEvent >*>(other))));
}
...
{
    return reinterpret_cast<data_collection_model_qo_e_metrics_event_t*>(new std::shared_ptr<QoEMetricsEvent >(std::move(*reinterpret_cast<std::shared_ptr<QoEMetricsEvent >*>(other))));
}
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_qo_e_metrics_event_t *data_collection_model_qo_e_metrics_event_copy(data_collection_model_qo_e_metrics_event_t *qo_e_metrics_event, const data_collection_model_qo_e_metrics_event_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<QoEMetricsEvent >*>(other);
...
{
    std::shared_ptr<QoEMetricsEvent > &obj = *reinterpret_cast<std::shared_ptr<QoEMetricsEvent >*>(qo_e_metrics_event);
    obj = std::move(*reinterpret_cast<std::shared_ptr<QoEMetricsEvent >*>(other));
    return qo_e_metrics_event;
}
...
{
    if (obj_qo_e_metrics_event == NULL) return NULL;
