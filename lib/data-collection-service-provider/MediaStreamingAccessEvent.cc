...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_media_streaming_access_event_t *data_collection_model_media_streaming_access_event_create_ref(const data_collection_model_media_streaming_access_event_t *other)
{
    return reinterpret_cast<data_collection_model_media_streaming_access_event_t*>(new std::shared_ptr<MediaStreamingAccessEvent>(*reinterpret_cast<const std::shared_ptr<MediaStreamingAccessEvent >*>(other)));
}
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API cJSON *data_collection_model_media_streaming_access_event_toJSON(const data_collection_model_media_streaming_access_event_t *media_streaming_access_event, bool as_request)
{
    ...
    if (obj) {
        try {
            ...
            ogs_error("Failed to convert data_collection_model_media_streaming_access_event_t to cJSON [%s.%s]: %s", err.classname.c_str(), err.parameter.c_str(), err.what());
        }
    }
    return NULL;
}
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_media_streaming_access_event_has_provisioning_session_id(const data_collection_model_media_streaming_access_event_t *obj_media_streaming_access_event)
{
    if (!obj_media_streaming_access_event) return false;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_media_streaming_access_event_has_session_id(const data_collection_model_media_streaming_access_event_t *obj_media_streaming_access_event)
{
    if (!obj_media_streaming_access_event) return false;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_media_streaming_access_event_has_ue_identification(const data_collection_model_media_streaming_access_event_t *obj_media_streaming_access_event)
{
    if (!obj_media_streaming_access_event) return false;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_media_streaming_access_event_has_data_network_name(const data_collection_model_media_streaming_access_event_t *obj_media_streaming_access_event)
{
    if (!obj_media_streaming_access_event) return false;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_media_streaming_access_event_has_slice_id(const data_collection_model_media_streaming_access_event_t *obj_media_streaming_access_event)
{
    if (!obj_media_streaming_access_event) return false;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_media_streaming_access_event_has_ue_locations(const data_collection_model_media_streaming_access_event_t *obj_media_streaming_access_event)
{
    if (!obj_media_streaming_access_event) return false;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_media_streaming_access_event_t *data_collection_model_media_streaming_access_event_add_ue_locations(data_collection_model_media_streaming_access_event_t *obj_media_streaming_access_event, data_collection_model_location_area5_g_t* p_ue_locations)
{
    ...
    typedef typename MediaStreamingAccessEvent::UeLocationsType::value_type ContainerType;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const data_collection_model_location_area5_g_t* data_collection_model_media_streaming_access_event_get_entry_ue_locations(const data_collection_model_media_streaming_access_event_t *obj_media_streaming_access_event, size_t idx)
{
    if (!obj_media_streaming_access_event) {
    ...
    const MediaStreamingAccessEvent::UeLocationsType &container = obj->getUeLocations();
    ...
    typedef typename MediaStreamingAccessEvent::UeLocationsItemType ResultFromType;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_media_streaming_access_event_has_cache_status(const data_collection_model_media_streaming_access_event_t *obj_media_streaming_access_event)
{
    if (!obj_media_streaming_access_event) return false;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_media_streaming_access_event_has_connection_metrics(const data_collection_model_media_streaming_access_event_t *obj_media_streaming_access_event)
{
    if (!obj_media_streaming_access_event) return false;
