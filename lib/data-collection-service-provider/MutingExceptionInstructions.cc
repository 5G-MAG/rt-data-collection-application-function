...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_muting_exception_instructions_t *data_collection_model_muting_exception_instructions_create_ref(const data_collection_model_muting_exception_instructions_t *other)
{
    return reinterpret_cast<data_collection_model_muting_exception_instructions_t*>(new std::shared_ptr<MutingExceptionInstructions>(*reinterpret_cast<const std::shared_ptr<MutingExceptionInstructions >*>(other)));
}
