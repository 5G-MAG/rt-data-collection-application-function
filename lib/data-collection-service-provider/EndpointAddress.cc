...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_endpoint_address_t *data_collection_model_endpoint_address_create_ref(const data_collection_model_endpoint_address_t *other)
{
    return reinterpret_cast<data_collection_model_endpoint_address_t*>(new std::shared_ptr<EndpointAddress>(*reinterpret_cast<const std::shared_ptr<EndpointAddress >*>(other)));
}
