...
{
    return reinterpret_cast<data_collection_model_location_data_t*>(new std::shared_ptr<LocationData >(new LocationData(**reinterpret_cast<const std::shared_ptr<LocationData >*>(other))));
}
...
{
    return reinterpret_cast<data_collection_model_location_data_t*>(new std::shared_ptr<LocationData >(std::move(*reinterpret_cast<std::shared_ptr<LocationData >*>(other))));
}
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_location_data_t *data_collection_model_location_data_copy(data_collection_model_location_data_t *location_data, const data_collection_model_location_data_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<LocationData >*>(other);
...
{
    std::shared_ptr<LocationData > &obj = *reinterpret_cast<std::shared_ptr<LocationData >*>(location_data);
    obj = std::move(*reinterpret_cast<std::shared_ptr<LocationData >*>(other));
    return location_data;
}
