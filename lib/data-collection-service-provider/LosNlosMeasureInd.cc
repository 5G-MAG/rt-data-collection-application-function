...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_los_nlos_measure_ind_t *data_collection_model_los_nlos_measure_ind_create_ref(const data_collection_model_los_nlos_measure_ind_t *other)
{
    return reinterpret_cast<data_collection_model_los_nlos_measure_ind_t*>(new std::shared_ptr<LosNlosMeasureInd>(*reinterpret_cast<const std::shared_ptr<LosNlosMeasureInd >*>(other)));
}
