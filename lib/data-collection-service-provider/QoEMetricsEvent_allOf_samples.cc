...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_qo_e_metrics_event_all_of_samples_t *data_collection_model_qo_e_metrics_event_all_of_samples_create_ref(const data_collection_model_qo_e_metrics_event_all_of_samples_t *other)
{
    return reinterpret_cast<data_collection_model_qo_e_metrics_event_all_of_samples_t*>(new std::shared_ptr<QoEMetricsEvent_allOf_samples>(*reinterpret_cast<const std::shared_ptr<QoEMetricsEvent_allOf_samples >*>(other)));
}
