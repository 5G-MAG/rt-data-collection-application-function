...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_unidirectional_bit_rate_specification_t *data_collection_model_unidirectional_bit_rate_specification_create_ref(const data_collection_model_unidirectional_bit_rate_specification_t *other)
{
    return reinterpret_cast<data_collection_model_unidirectional_bit_rate_specification_t*>(new std::shared_ptr<UnidirectionalBitRateSpecification>(*reinterpret_cast<const std::shared_ptr<UnidirectionalBitRateSpecification >*>(other)));
}
