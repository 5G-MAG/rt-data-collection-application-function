...
{
    return reinterpret_cast<data_collection_model_anbr_network_assistance_invocation_record_t*>(new std::shared_ptr<ANBRNetworkAssistanceInvocationRecord >(new ANBRNetworkAssistanceInvocationRecord(**reinterpret_cast<const std::shared_ptr<ANBRNetworkAssistanceInvocationRecord >*>(other))));
}
...
{
    return reinterpret_cast<data_collection_model_anbr_network_assistance_invocation_record_t*>(new std::shared_ptr<ANBRNetworkAssistanceInvocationRecord >(std::move(*reinterpret_cast<std::shared_ptr<ANBRNetworkAssistanceInvocationRecord >*>(other))));
}
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_anbr_network_assistance_invocation_record_t *data_collection_model_anbr_network_assistance_invocation_record_copy(data_collection_model_anbr_network_assistance_invocation_record_t *anbr_network_assistance_invocation_record, const data_collection_model_anbr_network_assistance_invocation_record_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<ANBRNetworkAssistanceInvocationRecord >*>(other);
...
{
    std::shared_ptr<ANBRNetworkAssistanceInvocationRecord > &obj = *reinterpret_cast<std::shared_ptr<ANBRNetworkAssistanceInvocationRecord >*>(anbr_network_assistance_invocation_record);
    obj = std::move(*reinterpret_cast<std::shared_ptr<ANBRNetworkAssistanceInvocationRecord >*>(other));
    return anbr_network_assistance_invocation_record;
}
