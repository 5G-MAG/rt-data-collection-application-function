...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_anbr_network_assistance_invocation_record_t *data_collection_model_anbr_network_assistance_invocation_record_create_ref(const data_collection_model_anbr_network_assistance_invocation_record_t *other)
{
    return reinterpret_cast<data_collection_model_anbr_network_assistance_invocation_record_t*>(new std::shared_ptr<ANBRNetworkAssistanceInvocationRecord>(*reinterpret_cast<const std::shared_ptr<ANBRNetworkAssistanceInvocationRecord >*>(other)));
}
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API cJSON *data_collection_model_anbr_network_assistance_invocation_record_toJSON(const data_collection_model_anbr_network_assistance_invocation_record_t *anbr_network_assistance_invocation_record, bool as_request)
{
    ...
    if (obj) {
        try {
            ...
            ogs_error("Failed to convert data_collection_model_anbr_network_assistance_invocation_record_t to cJSON [%s.%s]: %s", err.classname.c_str(), err.parameter.c_str(), err.what());
        }
    }
    return NULL;
}
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const char* data_collection_model_anbr_network_assistance_invocation_record_get_entry_context_ids(const data_collection_model_anbr_network_assistance_invocation_record_t *obj_anbr_network_assistance_invocation_record, size_t idx)
{
    if (!obj_anbr_network_assistance_invocation_record) {
        const char *result = NULL;
    ...
    const ANBRNetworkAssistanceInvocationRecord::ContextIdsType &container = obj->getContextIds();
    ...
    typedef typename ANBRNetworkAssistanceInvocationRecord::ContextIdsItemType ResultFromType;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const data_collection_model_application_flow_description_t* data_collection_model_anbr_network_assistance_invocation_record_get_entry_application_flow_descriptions(const data_collection_model_anbr_network_assistance_invocation_record_t *obj_anbr_network_assistance_invocation_record, size_t idx)
{
    if (!obj_anbr_network_assistance_invocation_record) {
    ...
    const ANBRNetworkAssistanceInvocationRecord::ApplicationFlowDescriptionsType &container = obj->getApplicationFlowDescriptions();
    ...
    typedef typename ANBRNetworkAssistanceInvocationRecord::ApplicationFlowDescriptionsItemType ResultFromType;
    const ResultFromType &result_from = *itr;
