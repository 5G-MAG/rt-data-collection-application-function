...
{
    return reinterpret_cast<data_collection_model_network_assistance_type_any_of_t*>(new std::shared_ptr<NetworkAssistanceType_anyOf >(new NetworkAssistanceType_anyOf(**reinterpret_cast<const std::shared_ptr<NetworkAssistanceType_anyOf >*>(other))));
}
...
{
    return reinterpret_cast<data_collection_model_network_assistance_type_any_of_t*>(new std::shared_ptr<NetworkAssistanceType_anyOf >(std::move(*reinterpret_cast<std::shared_ptr<NetworkAssistanceType_anyOf >*>(other))));
}
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_network_assistance_type_any_of_t *data_collection_model_network_assistance_type_any_of_copy(data_collection_model_network_assistance_type_any_of_t *network_assistance_type_any_of, const data_collection_model_network_assistance_type_any_of_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<NetworkAssistanceType_anyOf >*>(other);
...
{
    std::shared_ptr<NetworkAssistanceType_anyOf > &obj = *reinterpret_cast<std::shared_ptr<NetworkAssistanceType_anyOf >*>(network_assistance_type_any_of);
    obj = std::move(*reinterpret_cast<std::shared_ptr<NetworkAssistanceType_anyOf >*>(other));
    return network_assistance_type_any_of;
}
