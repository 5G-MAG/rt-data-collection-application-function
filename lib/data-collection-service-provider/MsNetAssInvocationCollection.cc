...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_ms_net_ass_invocation_collection_t *data_collection_model_ms_net_ass_invocation_collection_create_ref(const data_collection_model_ms_net_ass_invocation_collection_t *other)
{
    return reinterpret_cast<data_collection_model_ms_net_ass_invocation_collection_t*>(new std::shared_ptr<MsNetAssInvocationCollection>(*reinterpret_cast<const std::shared_ptr<MsNetAssInvocationCollection >*>(other)));
}
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_ms_net_ass_invocation_collection_t *data_collection_model_ms_net_ass_invocation_collection_add_ms_net_ass_invocs(data_collection_model_ms_net_ass_invocation_collection_t *obj_ms_net_ass_invocation_collection, data_collection_model_network_assistance_session_t* p_ms_net_ass_invocs)
{
    ...
    data_collection_model_network_assistance_session_free
(p_ms_net_ass_invocs);
