...
{
    return reinterpret_cast<data_collection_model_service_experience_info_per_flow_t*>(new std::shared_ptr<ServiceExperienceInfoPerFlow >(new ServiceExperienceInfoPerFlow(**reinterpret_cast<const std::shared_ptr<ServiceExperienceInfoPerFlow >*>(other))));
}
...
{
    return reinterpret_cast<data_collection_model_service_experience_info_per_flow_t*>(new std::shared_ptr<ServiceExperienceInfoPerFlow >(std::move(*reinterpret_cast<std::shared_ptr<ServiceExperienceInfoPerFlow >*>(other))));
}
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_service_experience_info_per_flow_t *data_collection_model_service_experience_info_per_flow_copy(data_collection_model_service_experience_info_per_flow_t *service_experience_info_per_flow, const data_collection_model_service_experience_info_per_flow_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<ServiceExperienceInfoPerFlow >*>(other);
...
{
    std::shared_ptr<ServiceExperienceInfoPerFlow > &obj = *reinterpret_cast<std::shared_ptr<ServiceExperienceInfoPerFlow >*>(service_experience_info_per_flow);
    obj = std::move(*reinterpret_cast<std::shared_ptr<ServiceExperienceInfoPerFlow >*>(other));
    return service_experience_info_per_flow;
}
...
{
    if (obj_service_experience_info_per_flow == NULL) return NULL;
