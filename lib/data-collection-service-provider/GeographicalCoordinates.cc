...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_geographical_coordinates_t *data_collection_model_geographical_coordinates_create_ref(const data_collection_model_geographical_coordinates_t *other)
{
    return reinterpret_cast<data_collection_model_geographical_coordinates_t*>(new std::shared_ptr<GeographicalCoordinates>(*reinterpret_cast<const std::shared_ptr<GeographicalCoordinates >*>(other)));
}
