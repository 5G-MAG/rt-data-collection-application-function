...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_dynamic_policy_invocation_event_t *data_collection_model_dynamic_policy_invocation_event_create_ref(const data_collection_model_dynamic_policy_invocation_event_t *other)
{
    return reinterpret_cast<data_collection_model_dynamic_policy_invocation_event_t*>(new std::shared_ptr<DynamicPolicyInvocationEvent>(*reinterpret_cast<const std::shared_ptr<DynamicPolicyInvocationEvent >*>(other)));
}
