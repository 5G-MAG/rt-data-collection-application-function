...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_communication_collection_t *data_collection_model_communication_collection_create_ref(const data_collection_model_communication_collection_t *other)
{
    return reinterpret_cast<data_collection_model_communication_collection_t*>(new std::shared_ptr<CommunicationCollection>(*reinterpret_cast<const std::shared_ptr<CommunicationCollection >*>(other)));
}
