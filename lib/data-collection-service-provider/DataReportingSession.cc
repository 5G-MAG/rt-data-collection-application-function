...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_data_reporting_session_t *data_collection_model_data_reporting_session_create_ref(const data_collection_model_data_reporting_session_t *other)
{
    return reinterpret_cast<data_collection_model_data_reporting_session_t*>(new std::shared_ptr<DataReportingSession>(*reinterpret_cast<const std::shared_ptr<DataReportingSession >*>(other)));
}
