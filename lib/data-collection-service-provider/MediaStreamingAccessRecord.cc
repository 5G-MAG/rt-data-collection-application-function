...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_media_streaming_access_record_t *data_collection_model_media_streaming_access_record_create_ref(const data_collection_model_media_streaming_access_record_t *other)
{
    return reinterpret_cast<data_collection_model_media_streaming_access_record_t*>(new std::shared_ptr<MediaStreamingAccessRecord>(*reinterpret_cast<const std::shared_ptr<MediaStreamingAccessRecord >*>(other)));
}
