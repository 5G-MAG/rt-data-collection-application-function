...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_local3d_point_uncertainty_ellipsoid_t *data_collection_model_local3d_point_uncertainty_ellipsoid_create_ref(const data_collection_model_local3d_point_uncertainty_ellipsoid_t *other)
{
    return reinterpret_cast<data_collection_model_local3d_point_uncertainty_ellipsoid_t*>(new std::shared_ptr<Local3dPointUncertaintyEllipsoid>(*reinterpret_cast<const std::shared_ptr<Local3dPointUncertaintyEllipsoid >*>(other)));
}
