...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_dynamic_policy_invocations_collection_t *data_collection_model_dynamic_policy_invocations_collection_create(
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_dynamic_policy_invocations_collection_t *data_collection_model_dynamic_policy_invocations_collection_create_copy(const data_collection_model_dynamic_policy_invocations_collection_t *other)
{
    return reinterpret_cast<data_collection_model_dynamic_policy_invocations_collection_t*>(new std::shared_ptr<DynamicPolicyInvocationsCollection >(new DynamicPolicyInvocationsCollection(**reinterpret_cast<const std::shared_ptr<DynamicPolicyInvocationsCollection >*>(other))));
}

DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_dynamic_policy_invocations_collection_t *data_collection_model_dynamic_policy_invocations_collection_create_move(data_collection_model_dynamic_policy_invocations_collection_t *other)
{
    return reinterpret_cast<data_collection_model_dynamic_policy_invocations_collection_t*>(new std::shared_ptr<DynamicPolicyInvocationsCollection >(std::move(*reinterpret_cast<std::shared_ptr<DynamicPolicyInvocationsCollection >*>(other))));
}

DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_dynamic_policy_invocations_collection_t *data_collection_model_dynamic_policy_invocations_collection_copy(data_collection_model_dynamic_policy_invocations_collection_t *dynamic_policy_invocations_collection, const data_collection_model_dynamic_policy_invocations_collection_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<DynamicPolicyInvocationsCollection >*>(other);
...
{
    std::shared_ptr<DynamicPolicyInvocationsCollection > &obj = *reinterpret_cast<std::shared_ptr<DynamicPolicyInvocationsCollection >*>(dynamic_policy_invocations_collection);
    obj = std::move(*reinterpret_cast<std::shared_ptr<DynamicPolicyInvocationsCollection >*>(other));
    return dynamic_policy_invocations_collection;
}

DATA_COLLECTION_SVC_PRODUCER_API extern "C" void data_collection_model_dynamic_policy_invocations_collection_free(data_collection_model_dynamic_policy_invocations_collection_t *dynamic_policy_invocations_collection)
{
    delete reinterpret_cast<std::shared_ptr<DynamicPolicyInvocationsCollection >*>(dynamic_policy_invocations_collection);
}

DATA_COLLECTION_SVC_PRODUCER_API extern "C" cJSON *data_collection_model_dynamic_policy_invocations_collection_toJSON(const data_collection_model_dynamic_policy_invocations_collection_t *dynamic_policy_invocations_collection, bool as_request)
{
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_dynamic_policy_invocations_collection_t *data_collection_model_dynamic_policy_invocations_collection_fromJSON(cJSON *json, bool as_request, char **error_reason, char **error_class, char **error_parameter)
{
...
{
    if (obj_dynamic_policy_invocations_collection == NULL) return NULL;
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" const char* data_collection_model_dynamic_policy_invocations_collection_get_start_timestamp(const data_collection_model_dynamic_policy_invocations_collection_t *obj_dynamic_policy_invocations_collection)
{
    const std::shared_ptr<DynamicPolicyInvocationsCollection > &obj = *reinterpret_cast<const std::shared_ptr<DynamicPolicyInvocationsCollection >*>(obj_dynamic_policy_invocations_collection);
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" const char* data_collection_model_dynamic_policy_invocations_collection_get_end_timestamp(const data_collection_model_dynamic_policy_invocations_collection_t *obj_dynamic_policy_invocations_collection)
{
    const std::shared_ptr<DynamicPolicyInvocationsCollection > &obj = *reinterpret_cast<const std::shared_ptr<DynamicPolicyInvocationsCollection >*>(obj_dynamic_policy_invocations_collection);
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" const int32_t data_collection_model_dynamic_policy_invocations_collection_get_sample_count(const data_collection_model_dynamic_policy_invocations_collection_t *obj_dynamic_policy_invocations_collection)
{
    const std::shared_ptr<DynamicPolicyInvocationsCollection > &obj = *reinterpret_cast<const std::shared_ptr<DynamicPolicyInvocationsCollection >*>(obj_dynamic_policy_invocations_collection);
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" const data_collection_model_provisioning_session_type_t* data_collection_model_dynamic_policy_invocations_collection_get_streaming_direction(const data_collection_model_dynamic_policy_invocations_collection_t *obj_dynamic_policy_invocations_collection)
{
    const std::shared_ptr<DynamicPolicyInvocationsCollection > &obj = *reinterpret_cast<const std::shared_ptr<DynamicPolicyInvocationsCollection >*>(obj_dynamic_policy_invocations_collection);
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" ogs_list_t* data_collection_model_dynamic_policy_invocations_collection_get_summarisations(const data_collection_model_dynamic_policy_invocations_collection_t *obj_dynamic_policy_invocations_collection)
{
    const std::shared_ptr<DynamicPolicyInvocationsCollection > &obj = *reinterpret_cast<const std::shared_ptr<DynamicPolicyInvocationsCollection >*>(obj_dynamic_policy_invocations_collection);
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_dynamic_policy_invocations_collection_t *data_collection_model_dynamic_policy_invocations_collection_clear_summarisations(data_collection_model_dynamic_policy_invocations_collection_t *obj_dynamic_policy_invocations_collection)
{   
    std::shared_ptr<DynamicPolicyInvocationsCollection > &obj = *reinterpret_cast<std::shared_ptr<DynamicPolicyInvocationsCollection >*>(obj_dynamic_policy_invocations_collection);
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" ogs_list_t* data_collection_model_dynamic_policy_invocations_collection_get_records(const data_collection_model_dynamic_policy_invocations_collection_t *obj_dynamic_policy_invocations_collection)
{
    const std::shared_ptr<DynamicPolicyInvocationsCollection > &obj = *reinterpret_cast<const std::shared_ptr<DynamicPolicyInvocationsCollection >*>(obj_dynamic_policy_invocations_collection);
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_dynamic_policy_invocations_collection_t *data_collection_model_dynamic_policy_invocations_collection_clear_records(data_collection_model_dynamic_policy_invocations_collection_t *obj_dynamic_policy_invocations_collection)
{   
    std::shared_ptr<DynamicPolicyInvocationsCollection > &obj = *reinterpret_cast<std::shared_ptr<DynamicPolicyInvocationsCollection >*>(obj_dynamic_policy_invocations_collection);
    obj->clearRecords();
    return obj_dynamic_policy_invocations_collection;
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_lnode_t *data_collection_model_dynamic_policy_invocations_collection_make_lnode(data_collection_model_dynamic_policy_invocations_collection_t *p_dynamic_policy_invocations_collection)
{
