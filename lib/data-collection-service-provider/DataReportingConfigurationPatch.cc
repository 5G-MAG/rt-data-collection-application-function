...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_data_reporting_configuration_patch_t *data_collection_model_data_reporting_configuration_patch_create_ref(const data_collection_model_data_reporting_configuration_patch_t *other)
{
    return reinterpret_cast<data_collection_model_data_reporting_configuration_patch_t*>(new std::shared_ptr<DataReportingConfigurationPatch>(*reinterpret_cast<const std::shared_ptr<DataReportingConfigurationPatch >*>(other)));
}
