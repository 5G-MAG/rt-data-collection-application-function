...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" bool data_collection_model_traffic_profile_any_of_is_equal_to(const data_collection_model_traffic_profile_any_of_t *first, const data_collection_model_traffic_profile_any_of_t *second)
{
