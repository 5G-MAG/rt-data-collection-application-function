...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_nf_type_any_of_t *data_collection_model_nf_type_any_of_create()
{
    return reinterpret_cast<data_collection_model_nf_type_any_of_t*>(new std::shared_ptr<NFType_anyOf>(new NFType_anyOf()));
}

DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_nf_type_any_of_t *data_collection_model_nf_type_any_of_create_copy(const data_collection_model_nf_type_any_of_t *other)
{
    return reinterpret_cast<data_collection_model_nf_type_any_of_t*>(new std::shared_ptr<NFType_anyOf >(new NFType_anyOf(**reinterpret_cast<const std::shared_ptr<NFType_anyOf >*>(other))));
}

DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_nf_type_any_of_t *data_collection_model_nf_type_any_of_create_move(data_collection_model_nf_type_any_of_t *other)
{
    return reinterpret_cast<data_collection_model_nf_type_any_of_t*>(new std::shared_ptr<NFType_anyOf >(std::move(*reinterpret_cast<std::shared_ptr<NFType_anyOf >*>(other))));
}

DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_nf_type_any_of_t *data_collection_model_nf_type_any_of_copy(data_collection_model_nf_type_any_of_t *nf_type_any_of, const data_collection_model_nf_type_any_of_t *other)
{
    std::shared_ptr<NFType_anyOf > &obj = *reinterpret_cast<std::shared_ptr<NFType_anyOf >*>(nf_type_any_of);
    *obj = **reinterpret_cast<const std::shared_ptr<NFType_anyOf >*>(other);
    return nf_type_any_of;
}

DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_nf_type_any_of_t *data_collection_model_nf_type_any_of_move(data_collection_model_nf_type_any_of_t *nf_type_any_of, data_collection_model_nf_type_any_of_t *other)
{
    std::shared_ptr<NFType_anyOf > &obj = *reinterpret_cast<std::shared_ptr<NFType_anyOf >*>(nf_type_any_of);
    obj = std::move(*reinterpret_cast<std::shared_ptr<NFType_anyOf >*>(other));
    return nf_type_any_of;
}

DATA_COLLECTION_SVC_PRODUCER_API extern "C" void data_collection_model_nf_type_any_of_free(data_collection_model_nf_type_any_of_t *nf_type_any_of)
{
    delete reinterpret_cast<std::shared_ptr<NFType_anyOf >*>(nf_type_any_of);
}

DATA_COLLECTION_SVC_PRODUCER_API extern "C" cJSON *data_collection_model_nf_type_any_of_toJSON(const data_collection_model_nf_type_any_of_t *nf_type_any_of, bool as_request)
{
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_nf_type_any_of_t *data_collection_model_nf_type_any_of_fromJSON(cJSON *json, bool as_request, char **error_reason, char **error_class, char **error_parameter)
{
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" bool data_collection_model_nf_type_any_of_is_equal_to(const data_collection_model_nf_type_any_of_t *first, const data_collection_model_nf_type_any_of_t *second)
{
...
DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_nf_type_any_of_e data_collection_model_nf_type_any_of_get_enum(const data_collection_model_nf_type_any_of_t *obj_nf_type_any_of)
{
...
DATA_COLLECTION_SVC_PRODUCER_API const char *data_collection_model_nf_type_any_of_get_string(const data_collection_model_nf_type_any_of_t *obj_nf_type_any_of)
{
    const std::shared_ptr<NFType_anyOf > &obj = *reinterpret_cast<const std::shared_ptr<NFType_anyOf >*>(obj_nf_type_any_of);
    return obj->getString().c_str();
}

DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_nf_type_any_of_set_enum(data_collection_model_nf_type_any_of_t *obj_nf_type_any_of, data_collection_model_nf_type_any_of_e p_value)
{
...
DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_nf_type_any_of_set_string(data_collection_model_nf_type_any_of_t *obj_nf_type_any_of, const char *p_value)
{
    std::shared_ptr<NFType_anyOf > &obj = *reinterpret_cast<std::shared_ptr<NFType_anyOf >*>(obj_nf_type_any_of);
    if (p_value) {
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_lnode_t *data_collection_model_nf_type_any_of_make_lnode(data_collection_model_nf_type_any_of_t *p_nf_type_any_of)
{
