...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_nwdaf_event_t *data_collection_model_nwdaf_event_create()
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_nwdaf_event_t *data_collection_model_nwdaf_event_create_move(data_collection_model_nwdaf_event_t *other)
{
    if (!other) return NULL;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_nwdaf_event_t *data_collection_model_nwdaf_event_copy(data_collection_model_nwdaf_event_t *nwdaf_event, const data_collection_model_nwdaf_event_t *other)
{
    if (nwdaf_event) {
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_nwdaf_event_t *data_collection_model_nwdaf_event_move(data_collection_model_nwdaf_event_t *nwdaf_event, data_collection_model_nwdaf_event_t *other)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API void data_collection_model_nwdaf_event_free(data_collection_model_nwdaf_event_t *nwdaf_event)
{
    if (!nwdaf_event) return;
    delete reinterpret_cast<std::shared_ptr<NwdafEvent >*>(nwdaf_event);
}

extern "C" DATA_COLLECTION_SVC_PRODUCER_API cJSON *data_collection_model_nwdaf_event_toJSON(const data_collection_model_nwdaf_event_t *nwdaf_event, bool as_request)
{
    ...
    if (obj) {
        try {
            ...
            ogs_error("Failed to convert data_collection_model_nwdaf_event_t to cJSON [%s.%s]: %s", err.classname.c_str(), err.parameter.c_str(), err.what());
        }
    }
    return NULL;
}

extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_nwdaf_event_t *data_collection_model_nwdaf_event_fromJSON(cJSON *json, bool as_request, char **error_reason, char **error_class, char **error_parameter)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_nwdaf_event_is_equal_to(const data_collection_model_nwdaf_event_t *first, const data_collection_model_nwdaf_event_t *second)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_nwdaf_event_is_not_set(const data_collection_model_nwdaf_event_t *obj_nwdaf_event)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_nwdaf_event_is_non_standard(const data_collection_model_nwdaf_event_t *obj_nwdaf_event)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_nwdaf_event_e data_collection_model_nwdaf_event_get_enum(const data_collection_model_nwdaf_event_t *obj_nwdaf_event)
{
    if (!obj_nwdaf_event)
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const char *data_collection_model_nwdaf_event_get_string(const data_collection_model_nwdaf_event_t *obj_nwdaf_event)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_nwdaf_event_set_enum(data_collection_model_nwdaf_event_t *obj_nwdaf_event, data_collection_model_nwdaf_event_e p_value)
{
    if (!obj_nwdaf_event) return false;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_nwdaf_event_set_string(data_collection_model_nwdaf_event_t *obj_nwdaf_event, const char *p_value)
{
    if (!obj_nwdaf_event) return false;
    std::shared_ptr<NwdafEvent > &obj = *reinterpret_cast<std::shared_ptr<NwdafEvent >*>(obj_nwdaf_event);
    if (!obj) return false;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_lnode_t *data_collection_model_nwdaf_event_make_lnode(data_collection_model_nwdaf_event_t *p_nwdaf_event)
{
