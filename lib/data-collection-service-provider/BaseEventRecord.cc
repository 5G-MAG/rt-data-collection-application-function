...
{
    return reinterpret_cast<data_collection_model_base_event_record_t*>(new std::shared_ptr<BaseEventRecord >(new BaseEventRecord(**reinterpret_cast<const std::shared_ptr<BaseEventRecord >*>(other))));
}
...
{
    return reinterpret_cast<data_collection_model_base_event_record_t*>(new std::shared_ptr<BaseEventRecord >(std::move(*reinterpret_cast<std::shared_ptr<BaseEventRecord >*>(other))));
}
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_base_event_record_t *data_collection_model_base_event_record_copy(data_collection_model_base_event_record_t *base_event_record, const data_collection_model_base_event_record_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<BaseEventRecord >*>(other);
...
{
    std::shared_ptr<BaseEventRecord > &obj = *reinterpret_cast<std::shared_ptr<BaseEventRecord >*>(base_event_record);
    obj = std::move(*reinterpret_cast<std::shared_ptr<BaseEventRecord >*>(other));
    return base_event_record;
}
...
{
    if (obj_base_event_record == NULL) return NULL;
