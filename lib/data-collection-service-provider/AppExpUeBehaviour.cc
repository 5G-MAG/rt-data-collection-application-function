...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_app_exp_ue_behaviour_t *data_collection_model_app_exp_ue_behaviour_create_ref(const data_collection_model_app_exp_ue_behaviour_t *other)
{
    return reinterpret_cast<data_collection_model_app_exp_ue_behaviour_t*>(new std::shared_ptr<AppExpUeBehaviour>(*reinterpret_cast<const std::shared_ptr<AppExpUeBehaviour >*>(other)));
}
