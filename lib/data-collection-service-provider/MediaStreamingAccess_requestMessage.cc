...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_media_streaming_access_request_message_t *data_collection_model_media_streaming_access_request_message_create_ref(const data_collection_model_media_streaming_access_request_message_t *other)
{
    return reinterpret_cast<data_collection_model_media_streaming_access_request_message_t*>(new std::shared_ptr<MediaStreamingAccess_requestMessage>(*reinterpret_cast<const std::shared_ptr<MediaStreamingAccess_requestMessage >*>(other)));
}
