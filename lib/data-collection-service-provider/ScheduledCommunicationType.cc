...
{
    return reinterpret_cast<data_collection_model_scheduled_communication_type_t*>(new std::shared_ptr<ScheduledCommunicationType >(new ScheduledCommunicationType(**reinterpret_cast<const std::shared_ptr<ScheduledCommunicationType >*>(other))));
}
...
{
    return reinterpret_cast<data_collection_model_scheduled_communication_type_t*>(new std::shared_ptr<ScheduledCommunicationType >(std::move(*reinterpret_cast<std::shared_ptr<ScheduledCommunicationType >*>(other))));
}
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_scheduled_communication_type_t *data_collection_model_scheduled_communication_type_copy(data_collection_model_scheduled_communication_type_t *scheduled_communication_type, const data_collection_model_scheduled_communication_type_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<ScheduledCommunicationType >*>(other);
...
{
    std::shared_ptr<ScheduledCommunicationType > &obj = *reinterpret_cast<std::shared_ptr<ScheduledCommunicationType >*>(scheduled_communication_type);
    obj = std::move(*reinterpret_cast<std::shared_ptr<ScheduledCommunicationType >*>(other));
    return scheduled_communication_type;
}
