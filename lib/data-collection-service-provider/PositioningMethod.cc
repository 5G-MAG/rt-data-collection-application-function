...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_positioning_method_t *data_collection_model_positioning_method_create_ref(const data_collection_model_positioning_method_t *other)
{
    return reinterpret_cast<data_collection_model_positioning_method_t*>(new std::shared_ptr<PositioningMethod>(*reinterpret_cast<const std::shared_ptr<PositioningMethod >*>(other)));
}
