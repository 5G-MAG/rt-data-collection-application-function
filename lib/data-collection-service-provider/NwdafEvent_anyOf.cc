...
{
    return reinterpret_cast<data_collection_model_nwdaf_event_any_of_t*>(new std::shared_ptr<NwdafEvent_anyOf >(new NwdafEvent_anyOf(**reinterpret_cast<const std::shared_ptr<NwdafEvent_anyOf >*>(other))));
}
...
{
    return reinterpret_cast<data_collection_model_nwdaf_event_any_of_t*>(new std::shared_ptr<NwdafEvent_anyOf >(std::move(*reinterpret_cast<std::shared_ptr<NwdafEvent_anyOf >*>(other))));
}
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_nwdaf_event_any_of_t *data_collection_model_nwdaf_event_any_of_copy(data_collection_model_nwdaf_event_any_of_t *nwdaf_event_any_of, const data_collection_model_nwdaf_event_any_of_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<NwdafEvent_anyOf >*>(other);
...
{
    std::shared_ptr<NwdafEvent_anyOf > &obj = *reinterpret_cast<std::shared_ptr<NwdafEvent_anyOf >*>(nwdaf_event_any_of);
    obj = std::move(*reinterpret_cast<std::shared_ptr<NwdafEvent_anyOf >*>(other));
    return nwdaf_event_any_of;
}
