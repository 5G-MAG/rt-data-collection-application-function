...
{
    return reinterpret_cast<data_collection_model_civic_address_t*>(new std::shared_ptr<CivicAddress >(new CivicAddress(**reinterpret_cast<const std::shared_ptr<CivicAddress >*>(other))));
}
...
{
    return reinterpret_cast<data_collection_model_civic_address_t*>(new std::shared_ptr<CivicAddress >(std::move(*reinterpret_cast<std::shared_ptr<CivicAddress >*>(other))));
}
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_civic_address_t *data_collection_model_civic_address_copy(data_collection_model_civic_address_t *civic_address, const data_collection_model_civic_address_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<CivicAddress >*>(other);
...
{
    std::shared_ptr<CivicAddress > &obj = *reinterpret_cast<std::shared_ptr<CivicAddress >*>(civic_address);
    obj = std::move(*reinterpret_cast<std::shared_ptr<CivicAddress >*>(other));
    return civic_address;
}
...
{
    if (obj_civic_address == NULL) return NULL;
