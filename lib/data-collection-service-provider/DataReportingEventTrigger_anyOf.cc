...
{
    return reinterpret_cast<data_collection_model_data_reporting_event_trigger_any_of_t*>(new std::shared_ptr<DataReportingEventTrigger_anyOf >(new DataReportingEventTrigger_anyOf(**reinterpret_cast<const std::shared_ptr<DataReportingEventTrigger_anyOf >*>(other))));
}
...
{
    return reinterpret_cast<data_collection_model_data_reporting_event_trigger_any_of_t*>(new std::shared_ptr<DataReportingEventTrigger_anyOf >(std::move(*reinterpret_cast<std::shared_ptr<DataReportingEventTrigger_anyOf >*>(other))));
}
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_data_reporting_event_trigger_any_of_t *data_collection_model_data_reporting_event_trigger_any_of_copy(data_collection_model_data_reporting_event_trigger_any_of_t *data_reporting_event_trigger_any_of, const data_collection_model_data_reporting_event_trigger_any_of_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<DataReportingEventTrigger_anyOf >*>(other);
...
{
    std::shared_ptr<DataReportingEventTrigger_anyOf > &obj = *reinterpret_cast<std::shared_ptr<DataReportingEventTrigger_anyOf >*>(data_reporting_event_trigger_any_of);
    obj = std::move(*reinterpret_cast<std::shared_ptr<DataReportingEventTrigger_anyOf >*>(other));
    return data_reporting_event_trigger_any_of;
}
