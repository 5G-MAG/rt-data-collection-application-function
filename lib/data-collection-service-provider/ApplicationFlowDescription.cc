...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_application_flow_description_t *data_collection_model_application_flow_description_create_ref(const data_collection_model_application_flow_description_t *other)
{
    return reinterpret_cast<data_collection_model_application_flow_description_t*>(new std::shared_ptr<ApplicationFlowDescription>(*reinterpret_cast<const std::shared_ptr<ApplicationFlowDescription >*>(other)));
}
