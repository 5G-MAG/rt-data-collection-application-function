...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_point_t *data_collection_model_point_create_ref(const data_collection_model_point_t *other)
{
    return reinterpret_cast<data_collection_model_point_t*>(new std::shared_ptr<Point>(*reinterpret_cast<const std::shared_ptr<Point >*>(other)));
}
