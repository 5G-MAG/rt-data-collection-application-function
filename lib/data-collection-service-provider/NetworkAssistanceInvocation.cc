...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_network_assistance_invocation_t *data_collection_model_network_assistance_invocation_create_ref(const data_collection_model_network_assistance_invocation_t *other)
{
    return reinterpret_cast<data_collection_model_network_assistance_invocation_t*>(new std::shared_ptr<NetworkAssistanceInvocation>(*reinterpret_cast<const std::shared_ptr<NetworkAssistanceInvocation >*>(other)));
}
