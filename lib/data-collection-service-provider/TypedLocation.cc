...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_typed_location_t *data_collection_model_typed_location_create_ref(const data_collection_model_typed_location_t *other)
{
    return reinterpret_cast<data_collection_model_typed_location_t*>(new std::shared_ptr<TypedLocation>(*reinterpret_cast<const std::shared_ptr<TypedLocation >*>(other)));
}
