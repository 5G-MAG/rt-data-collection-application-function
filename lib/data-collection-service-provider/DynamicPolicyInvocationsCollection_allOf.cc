...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_dynamic_policy_invocations_collection_all_of_t *data_collection_model_dynamic_policy_invocations_collection_all_of_create_ref(const data_collection_model_dynamic_policy_invocations_collection_all_of_t *other)
{
    return reinterpret_cast<data_collection_model_dynamic_policy_invocations_collection_all_of_t*>(new std::shared_ptr<DynamicPolicyInvocationsCollection_allOf>(*reinterpret_cast<const std::shared_ptr<DynamicPolicyInvocationsCollection_allOf >*>(other)));
}
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API cJSON *data_collection_model_dynamic_policy_invocations_collection_all_of_toJSON(const data_collection_model_dynamic_policy_invocations_collection_all_of_t *dynamic_policy_invocations_collection_all_of, bool as_request)
{
    ...
    if (obj) {
        try {
            ...
            ogs_error("Failed to convert data_collection_model_dynamic_policy_invocations_collection_all_of_t to cJSON [%s.%s]: %s", err.classname.c_str(), err.parameter.c_str(), err.what());
        }
    }
    return NULL;
}
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_dynamic_policy_invocations_collection_all_of_t *data_collection_model_dynamic_policy_invocations_collection_all_of_add_records(data_collection_model_dynamic_policy_invocations_collection_all_of_t *obj_dynamic_policy_invocations_collection_all_of, data_collection_model_dynamic_policy_invocation_event_t* p_records)
{
    ...
    data_collection_model_dynamic_policy_invocation_event_free
(p_records);
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const data_collection_model_dynamic_policy_invocation_event_t* data_collection_model_dynamic_policy_invocations_collection_all_of_get_entry_records(const data_collection_model_dynamic_policy_invocations_collection_all_of_t *obj_dynamic_policy_invocations_collection_all_of, size_t idx)
{
    if (!obj_dynamic_policy_invocations_collection_all_of) {
    ...
    const DynamicPolicyInvocationsCollection_allOf::RecordsType &container = obj->getRecords();
    ...
    typedef typename DynamicPolicyInvocationsCollection_allOf::RecordsItemType ResultFromType;
