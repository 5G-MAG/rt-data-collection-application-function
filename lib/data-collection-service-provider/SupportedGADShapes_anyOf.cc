...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_supported_gad_shapes_any_of_t *data_collection_model_supported_gad_shapes_any_of_create_ref(const data_collection_model_supported_gad_shapes_any_of_t *other)
{
    return reinterpret_cast<data_collection_model_supported_gad_shapes_any_of_t*>(new std::shared_ptr<SupportedGADShapes_anyOf>(*reinterpret_cast<const std::shared_ptr<SupportedGADShapes_anyOf >*>(other)));
}
