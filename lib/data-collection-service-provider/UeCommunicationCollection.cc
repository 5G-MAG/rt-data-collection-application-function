...
{
    return reinterpret_cast<data_collection_model_ue_communication_collection_t*>(new std::shared_ptr<UeCommunicationCollection >(new UeCommunicationCollection(**reinterpret_cast<const std::shared_ptr<UeCommunicationCollection >*>(other))));
}
...
{
    return reinterpret_cast<data_collection_model_ue_communication_collection_t*>(new std::shared_ptr<UeCommunicationCollection >(std::move(*reinterpret_cast<std::shared_ptr<UeCommunicationCollection >*>(other))));
}
...
DATA_COLLECTION_SVC_PRODUCER_API extern "C" data_collection_model_ue_communication_collection_t *data_collection_model_ue_communication_collection_copy(data_collection_model_ue_communication_collection_t *ue_communication_collection, const data_collection_model_ue_communication_collection_t *other)
{
    ...
    *obj = **reinterpret_cast<const std::shared_ptr<UeCommunicationCollection >*>(other);
...
{
    std::shared_ptr<UeCommunicationCollection > &obj = *reinterpret_cast<std::shared_ptr<UeCommunicationCollection >*>(ue_communication_collection);
    obj = std::move(*reinterpret_cast<std::shared_ptr<UeCommunicationCollection >*>(other));
    return ue_communication_collection;
}
...
{
    if (obj_ue_communication_collection == NULL) return NULL;
