...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_data_reporting_condition_t *data_collection_model_data_reporting_condition_create_ref(const data_collection_model_data_reporting_condition_t *other)
{
    return reinterpret_cast<data_collection_model_data_reporting_condition_t*>(new std::shared_ptr<DataReportingCondition>(*reinterpret_cast<const std::shared_ptr<DataReportingCondition >*>(other)));
}
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API cJSON *data_collection_model_data_reporting_condition_toJSON(const data_collection_model_data_reporting_condition_t *data_reporting_condition, bool as_request)
{
    ...
    if (obj) {
        try {
            ...
            ogs_error("Failed to convert data_collection_model_data_reporting_condition_t to cJSON [%s.%s]: %s", err.classname.c_str(), err.parameter.c_str(), err.what());
        }
    }
    return NULL;
}
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API bool data_collection_model_data_reporting_condition_has_context_ids(const data_collection_model_data_reporting_condition_t *obj_data_reporting_condition)
{
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_data_reporting_condition_t *data_collection_model_data_reporting_condition_add_context_ids(data_collection_model_data_reporting_condition_t *obj_data_reporting_condition, char* p_context_ids)
{
    ...
    typedef typename DataReportingCondition::ContextIdsType::value_type ContainerType;
...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API const char* data_collection_model_data_reporting_condition_get_entry_context_ids(const data_collection_model_data_reporting_condition_t *obj_data_reporting_condition, size_t idx)
{
    if (!obj_data_reporting_condition) {
    ...
    const DataReportingCondition::ContextIdsType &container = obj->getContextIds();
    ...
    typedef typename DataReportingCondition::ContextIdsItemType ResultFromType;
