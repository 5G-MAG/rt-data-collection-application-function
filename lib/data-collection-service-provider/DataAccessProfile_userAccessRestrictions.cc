...
extern "C" DATA_COLLECTION_SVC_PRODUCER_API data_collection_model_data_access_profile_user_access_restrictions_t *data_collection_model_data_access_profile_user_access_restrictions_create_ref(const data_collection_model_data_access_profile_user_access_restrictions_t *other)
{
    return reinterpret_cast<data_collection_model_data_access_profile_user_access_restrictions_t*>(new std::shared_ptr<DataAccessProfile_userAccessRestrictions>(*reinterpret_cast<const std::shared_ptr<DataAccessProfile_userAccessRestrictions >*>(other)));
}
